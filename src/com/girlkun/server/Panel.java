    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == baotri) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                String vp = idit.getText();
                String idop1 = idop.getText();
                String param = par.getText();
                String sl = quanity.getText();
                if (!name.isEmpty()) {
                ...
                String[] idOptionArray = idop1.split(" ");
                // Tách chuỗi paraml thành mảng các số
                String[] slOptionArray = param.split(" ");
                if (idOptionArray.length == slOptionArray.length) {
                    ...
                    int slItemBuff = Integer.parseInt(sl);
                    Player pBuffItem = Client.gI().getPlayer(name);
                    if (pBuffItem != null) {
                        String txtBuff = "Admin gửi Player: " + pBuffItem.name + "\b";
                        ...
                        int idItemBuff = Integer.parseInt(vp);
                        if (idItemBuff == -1) {
