...
public class ItemService {
    ...
    public void OpenItem1925(Player player, Item itemUse) {
        try {
            ...
            short[] itemIds = {1928, 1932, 1933, 1431};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(18, 25)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(18, 25)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(18, 25))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(18, 25)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(18, 25)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(8, Util.nextInt(18, 25)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
                Service.getInstance().sendThongBao(player, "🌟 Chúc mừng! Bạn nhận được Pokemon vĩnh viễn!");
            }
            // Giao quà & thông báo
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, reward);
            InventoryServiceNew.gI().sendItemBags(player);
            Service.getInstance().sendThongBao(player, "🎁 Bạn nhận được " + reward.template.name + " siêu phẩm !");

            // Option: hiệu ứng mở quà nếu cần
            CombineServiceNew.gI().sendEffectOpenItem(player, itemUse.template.iconID, reward.template.iconID);

        } catch (Exception e) {
            e.printStackTrace();
            Service.getInstance().sendThongBao(player, "Có lỗi xảy ra khi mở hộp quà ");
        }
    }

    public void OpenItem1924(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            short[] itemIds = {1590, 1591, 1646, 1701, 1702};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15, 22)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15, 22)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15, 22))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(15, 22)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(15, 22)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(8, Util.nextInt(15, 22)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
    ...
    public void OpenItem1923(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            short[] itemIds = {1929, 1930, 1931};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(10, 18)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 18)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 18))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(10, 18)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(10, 18)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(8, Util.nextInt(10, 18)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
    ...
    public void OpenItem1969(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            short[] itemIds = {1977, 1978, 1979, 1980};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15, 25)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15, 25)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15, 25))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(15, 25)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(15, 25)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
                Service.getInstance().sendThongBao(player, "🌟 Chúc mừng! Bạn nhận được Ngọc Rồng vĩnh viễn!");
            }
            // Giao quà & thông báo
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, reward);
    ...
    public void OpenItem1968(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            short[] itemIds = {1973, 1974, 1975, 1976};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(10, 22)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 22)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 22))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(10, 15)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(10, 15)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
    ...
    public void OpenItem1970(Player player, Item itemUse) {
        try {
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 1) {
                Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
                return;
            ...
            short[] itemIds = {1953, 1954, 1955, 1956, 1957, 1958};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);
            ...
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 22)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 22))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(5, 8)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(10, 22)));  // Giáp %
            reward.itemOptions.add(new Item.ItemOption(101, Util.nextInt(10, 22)));  // TNSM
            reward.itemOptions.add(new Item.ItemOption(95, Util.nextInt(15, 22)));  // Option 95
            reward.itemOptions.add(new Item.ItemOption(96, Util.nextInt(15, 22)));
            reward.itemOptions.add(new Item.ItemOption(97, Util.nextInt(15, 22)));
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(99, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(3, 15)));
            } else {
                Service.getInstance().sendThongBao(player, "🌟 Chúc mừng! Bạn nhận được Bé Ba vĩnh viễn!");
            }
            // Giao quà & thông báo
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, reward);
    ...
    public void OpenItem1180(Player player, Item itemUse) {
        try {
            ...
            short[] itemIds = {1696, 1697, 1698, 1699, 1876};
            short chosenId = itemIds[Util.nextInt(itemIds.length)];
            Item reward = ItemService.gI().createItemSetKichHoat(chosenId, 1);

            // Các option ngẫu nhiên theo yêu cầu
            reward.itemOptions.add(new Item.ItemOption(50, Util.nextInt(15, 35)));  // Sức đánh %
            reward.itemOptions.add(new Item.ItemOption(77, Util.nextInt(15, 35)));  // HP %
            reward.itemOptions.add(new Item.ItemOption(103, Util.nextInt(15, 35))); // KI %
            reward.itemOptions.add(new Item.ItemOption(14, Util.nextInt(15, 20)));  // Chí mạng
            reward.itemOptions.add(new Item.ItemOption(5, Util.nextInt(75, 150)));  // Giáp %
            reward.itemOptions.add(new Item.ItemOption(101, Util.nextInt(15, 35)));  // TNSM
            reward.itemOptions.add(new Item.ItemOption(95, Util.nextInt(15, 35)));  // Option 95
            reward.itemOptions.add(new Item.ItemOption(96, Util.nextInt(15, 35)));
            reward.itemOptions.add(new Item.ItemOption(97, Util.nextInt(15, 35)));
            reward.itemOptions.add(new Item.ItemOption(30, 0));
            if (Util.isTrue(98, 100)) {
                reward.itemOptions.add(new Item.ItemOption(93, Util.nextInt(15, 90)));
            } else {
                Service.getInstance().sendThongBao(player, "🌟 Chúc mừng! Bạn nhận được Cải Trang vĩnh viễn!");
            }
            // Giao quà & thông báo
            InventoryServiceNew.gI().subQuantityItemsBag(player, itemUse, 1);
            InventoryServiceNew.gI().addItemBag(player, reward);
...
//    }
    ...
    public Item ThoiVang() {
        ...
        item.itemOptions.add(new Item.ItemOption(21, 1));//ko the gd
        return item;
    }
