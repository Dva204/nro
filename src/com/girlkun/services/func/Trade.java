...
//        if (pl.getSession().actived) {
    ...
    private void startTrade() {
        ...
        if (tradeStatus != SUCCESS) {
            ...
            List<Item> itemTradeHistoryP1 = new ArrayList<>();
            List<Item> itemTradeHistoryP2 = new ArrayList<>();
            for(Item item : itemsTrade1){
                Item copy = ItemService.gI().copyItem(item);
                copy.quantityGD = item.quantity;
                itemTradeHistoryP1.add(copy);
            }
            for(Item item : itemsTrade2){
                Item copy = ItemService.gI().copyItem(item);
                copy.quantityGD = item.quantity;
                itemTradeHistoryP2.add(copy);
            }
            for (Item item : itemsTrade1) {
            ...
            if (tradeStatus != SUCCESS) {
                ...
                if (tradeStatus == SUCCESS) {
                    ...
                    HistoryTransactionDAO.insert(player1, player2, goldTrade1, goldTrade2, itemTradeHistoryP1, itemTradeHistoryP2,
