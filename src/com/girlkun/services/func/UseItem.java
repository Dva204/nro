...
//                            break;
                        ...
                        case 2048:
                            ...
                            if (pl.pet.playerSkill.skills.get(2).skillId != -1 && pl.pet.playerSkill.skills.get(3).skillId != -1) {
                                pl.pet.openSkill3();
                                pl.pet.openSkill4();
                            ...
                            } else if (pl.pet.playerSkill.skills.get(2).skillId != -1) {
                                pl.pet.openSkill3();
                                InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Đã đổi thành công chiêu 3 đệ tử");
                            } else {
                                Service.gI().sendThongBao(pl, "Ít nhất đệ tử ngươi phải có chiêu 3 4 chứ!");
                            }
                            break;
                        case 2049:
                            if (pl.pet == null) {
                            ...
                            if (pl.pet.playerSkill.skills.get(1).skillId != -1 && pl.pet.playerSkill.skills.get(2).skillId != -1) {
                                ...
                                Service.gI().sendThongBao(pl, "Ít nhất đệ tử ngươi phải có chiêu 4 5 chứ!");
                            }
                            break;
                        case 2050:
                            if (pl.pet == null) {
                            ...
                            if (pl.pet.playerSkill.skills.get(2).skillId != -1 && pl.pet.playerSkill.skills.get(1).skillId != -1 && pl.pet.playerSkill.skills.get(3).skillId != -1 && pl.pet.playerSkill.skills.get(4).skillId != -1) {
                                //pl.pet.openSkill1();
                                pl.pet.openSkill2();
                                pl.pet.openSkill3();
                                pl.pet.openSkill4();
                                ...
                                InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Đã đổi thành công 5 chiêu đệ tử");
                            } else if (pl.pet.playerSkill.skills.get(1).skillId != -1) {
                                pl.pet.openSkill2();
                                InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Đã đổi thành công chiêu 2 đệ tử");
                            } else if (pl.pet.playerSkill.skills.get(2).skillId != -1 && pl.pet.playerSkill.skills.get(1).skillId != -1) {
                                pl.pet.openSkill2();
                                pl.pet.openSkill3();
                                InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Đã đổi thành công chiêu 2 và 3 đệ tử");
                            } else if (pl.pet.playerSkill.skills.get(2).skillId != -1 && pl.pet.playerSkill.skills.get(1).skillId != -1 && pl.pet.playerSkill.skills.get(3).skillId != -1) {
                                pl.pet.openSkill2();
                                pl.pet.openSkill3();
                                pl.pet.openSkill4();
                                InventoryServiceNew.gI().subQuantityItem(pl.inventory.itemsBag, item, 1);
                                InventoryServiceNew.gI().sendItemBags(pl);
                                Service.gI().sendThongBao(pl, "Đã đổi thành công chiêu 2, 3 và 4 đệ tử");
                            } else {
                                Service.gI().sendThongBao(pl, "Ít nhất đệ tử ngươi phải có 5 chiêu chứ!");
                            }
                            break;
                        case 987:
                        ...
                        case 1925:
                            ItemService.gI().OpenItem1180(pl, item);
                            break;
                        case 627: { // Đổi đệ tử hiện tại sang Piccolo
                            if (pl.pet == null) {
                                Service.gI().sendThongBao(pl, "Bạn chưa có đệ tử!");
                                return;
                            }

                            PetService.gI().createPetPiccolo(pl, true, pl.gender); // dùng giới tính nhân vật

                            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1); // Trừ item
                            Service.gI().sendThongBao(pl, "Đệ tử của bạn đã được chuyển thành Piccolo!");
                            break;
                        }
                        case 1996: {
                            if (pl.pet == null) {
                            ...
                            PetService.gI().createPetVegito(pl, true, pl.gender); // dùng giới tính nhân vật

                            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1); // Trừ item
                            Service.gI().sendThongBao(pl, "Đệ tử của bạn đã được chuyển thành Vegito!");
                            break;
                        }
                        case 1997: { // Đổi đệ tử hiện tại sang Piccolo
                            if (pl.pet == null) {
                                Service.gI().sendThongBao(pl, "Bạn chưa có đệ tử!");
                                return;
                            }

                            PetService.gI().createPetGogeta(pl, true, pl.gender); // dùng giới tính nhân vật

                            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1); // Trừ item
                            Service.gI().sendThongBao(pl, "Đệ tử của bạn đã được chuyển thành Gogeta!");
                            break;
                        }
                        case 1998: { // Đổi đệ tử hiện tại sang Piccolo
                            if (pl.pet == null) {
                                Service.gI().sendThongBao(pl, "Bạn chưa có đệ tử!");
                                return;
                            }

                            PetService.gI().createPetGokuBNVC(pl, true, pl.gender); // dùng giới tính nhân vật

                            InventoryServiceNew.gI().subQuantityItemsBag(pl, item, 1); // Trừ item
                            Service.gI().sendThongBao(pl, "Đệ tử của bạn đã được chuyển thành Goku BNVC!");
                            break;
                        }
                        ...
                        case 1131:
                            ...
                            if (pl.pet.playerSkill.skills.get(1).skillId != -1 && pl.pet.playerSkill.skills.get(2).skillId != -1) {
                                ...
                                Service.gI().sendThongBao(pl, "Ít nhất đệ tử ngươi phải có chiêu 2 3 chứ!");
                            }
                            break;
...
//                listClothesReward = new int[]{randClothes(param), randClothes(param)};
    ...
    private void openCSKB(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            ...
            int rand = Util.nextInt(1, 100); // random 1 - 100

            if (rand <= 30) {
                // Gold 30%
                int goldMin = 1_000_000;
                int goldMax = 2_000_000;
                pl.inventory.gold += Util.nextInt(goldMin, goldMax);
                if (pl.inventory.gold > Inventory.LIMIT_GOLD) {
                    pl.inventory.gold = Inventory.LIMIT_GOLD;
                }
                PlayerService.gI().sendInfoHpMpMoney(pl);
                icon[1] = 930; // icon gold
            } else {
                short itemId;
                if (rand <= 35) { // 5%
                    itemId = 381;
    ...
    private void OpenHit(Player pl, Item item) {
        if (InventoryServiceNew.gI().getCountEmptyBag(pl) > 0) {
            ...
            if (Util.isTrue(50, 100)) {
                ...
                it.itemOptions.add(new ItemOption(73, 0));
                InventoryServiceNew.gI().addItemBag(pl, it, 1);
