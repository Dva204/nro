...
public class CombineServiceNew {
    ...
    private static final long COSTPS = 20_000_000_000L;
    ...
    private static final byte MAX_STAR_KHAM_DA = 8;
    ...
    private static final byte MAX_LEVEL_PET2 = 8;
    ...
    public static final int NANG_CAP_SKH_THUONG = 615;
    ...
    private static final int RATIO_BONG_TAI3 = 20;
    private static final int RATIO_BONG_TAI4 = 10;
        ...
        switch (player.combineNew.typeCombine) {
            ...
            case NANG_CAP_BONG_TAI_CAP4:  //c4
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (bongTai != null && manhVo != null && manhVo.quantity >= 5000) {
                        ...
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Cần 1 Bông tai Porata cấp 3 và X5000 Mảnh vỡ bông tai cấp 3", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Cần 1 Bông tai Porata cấp 3 và X5000 Mảnh vỡ bông tai cấp 3", "Đóng");
            ...
            case GIA_HAN_VAT_PHAM:
                ...
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (player.inventory.gold > 500000000) {
                        npcSay += "|2|Cần 500Tr vàng";
                        baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                "Nâng cấp", "Từ chối");

                    } else if (player.inventory.gold < 500000000) {
                        int SoVangThieu2 = (int) (500000000 - player.inventory.gold);
                ...
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    if (isTrangBiGod1(item)) {
                        ...
                        if (thoivang != null && thoivang.quantity >= 10) {
                            npcSay += "Cần 10 Thỏi vàng \n";
                            baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                    "Nâng cấp");
                        } else {
                            npcSay += "Không đủ 10 thỏi vàng ";
//                                npcSay += "Còn thiếu " + Util.numberToMoney(player.combineNew.dakham - dakham.quantity) + " đá khảm \n và " + Util.numberToMoney(player.combineNew.ngusacCombine - dangusac.quantity) +" đá ngũ sắc";
                            baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Đóng");
                        }
                    } else {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Hãy cho 3 trang bị Thần Linh ", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Không có vật phẩm để nâng cấp", "Đóng");
                }
            ...
            case NANG_KICH_HOAT_VIP2:
                if (player.combineNew.itemsCombine.size() == 10) {
                    Item item = player.combineNew.itemsCombine.get(0);
                    Item item1 = player.combineNew.itemsCombine.get(1);
                    Item item2 = player.combineNew.itemsCombine.get(2);
                    Item item3 = player.combineNew.itemsCombine.get(3);
                    Item item4 = player.combineNew.itemsCombine.get(4);
                    Item item5 = player.combineNew.itemsCombine.get(5);
                    Item item6 = player.combineNew.itemsCombine.get(6);
                    Item item7 = player.combineNew.itemsCombine.get(7);
                    Item item8 = player.combineNew.itemsCombine.get(8);
                    Item item9 = player.combineNew.itemsCombine.get(9);

                    Item tv = InventoryServiceNew.gI().findItemBag(player, 457);

                    if (isTrangBiHakai(item) && isTrangBiHakai(item1) && isTrangBiHakai(item2) && isTrangBiHakai(item3) && isTrangBiHakai(item4) && isTrangBiHakai(item5) && isTrangBiHakai(item6) && isTrangBiHakai(item7) && isTrangBiHakai(item8) && isTrangBiHakai(item9)) {
                        //if (isTrangBiGod1(item) ) {
                        if (tv.quantity >= 50 && tv != null) {
                            player.combineNew.goldCombine = 10000;
                            if (player.gender == 0) {
                                String npcSay = "Con có muốn nâng cấp trang bị của mình\nTrang bị nâng cấp sẽ phụ thuộc trang bị Hủy diệt đầu tiên\nChắc chắn nhận được trang bị cấp Thần Linh";
                                if (player.combineNew.goldCombine <= player.inventory.ruby) {
                                    baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay,
                                            "Nâng cấp\n" + player.combineNew.goldCombine + " Hồng Ngọc\n");
                                } else {
                                    npcSay += "Còn thiếu " + Util.numberToMoney(player.combineNew.goldCombine - player.inventory.ruby) + " Hồng Ngọc";
                                    baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Đóng");
                                }
                            }
                            if (player.gender == 1) {
                            ...
                            this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Không đủ 50 thỏi vàng ", "Đóng");
                        }
                    } else {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Hãy cho 10 trang bị Thần linh ", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Không có vật phẩm để nâng cấp", "Đóng");
                }
                ...
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (isTrangBiGod(item1) && isLinhThu(item)) {
                        ...
                        if (star < MAX_LEVEL_PET) {
                            player.combineNew.goldCombine = 2000000000;
                            player.combineNew.ngusacCombine = 50;
...
//                                    "Nâng cấp\ncần " + player.combineNew.goldCombine + " hồng ngọc " );
            ...
            case CUONG_HOA:
                if (player.combineNew.itemsCombine.size() == 1) {
                    Item item = player.combineNew.itemsCombine.get(0);
                    if (isTrangBiAn(item)) {
                        player.combineNew.goldCombine = 200000000;
                        boolean star = false;
                        for (Item.ItemOption io : item.itemOptions) {
...
//                    Item item2 = player.combineNew.itemsCombine.get(2);
                    if (isTrangBiGod(item1) && isPhuKien(item)) {
                        ...
                        if (star < MAX_LEVEL_PET2) {
                            player.combineNew.goldCombine = 2000000000;
                            player.combineNew.ngusacCombine = 100;
            ...
            case AN_TRANG_BI:
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    if (player.combineNew.itemsCombine.size() == 3) {
                        ...
                        if (isTrangBiAn(item)) {
                            //if (item != null && item.isNotNullItem() && dangusac != null && dangusac.isNotNullItem() && (dangusac.template.id == 1232 || dangusac.template.id == 1233 || dangusac.template.id == 1234 || dangusac.template.id == 674) && dangusac.quantity >= 99) {
                            if (item != null && item.isNotNullItem() && dangusac != null && dangusac.isNotNullItem() && (dangusac.template.id == 674) && dangusac.quantity >= 99) {
                                String npcSay = item.template.name + "\n|2|";
                                for (Item.ItemOption io : item.itemOptions) {
                                    npcSay += io.getOptionString() + "\n";
                                }
...
// -----------------------------------------------------------------------------                  
            case DAP_SET_KICH_HOAT_HD:
                ...
                Item dns = null;
                List<Item> dhdList = new ArrayList<>();
                ...
                if (dhdList.size() != 3 || dns == null || dns.quantity < 50) {

                    this.baHatMit.createOtherMenu(player,
                            ConstNpc.IGNORE_MENU,
                            "Ta cần 3 Trang Bị Hủy Diệt và 50 viên Đá Ngũ Sắc",
                            "Đóng");
                    return;
                }

                boolean hasSKH = false;

                for (Item item : dhdList) {
                    if (item.isSKH()) {
                        hasSKH = true;
                        break;
                    }
                ...
                if (hasSKH) {
                    ...
                    this.baHatMit.createOtherMenu(player,
                            ConstNpc.IGNORE_MENU,
                            "Trang bị đã có SKH, không thể nâng cấp",
                            "Đóng");
                    return;
                }
                ...
                if (tv == null || tv.quantity < 100 || player.inventory.ruby < 20000) {

                    this.baHatMit.createOtherMenu(player,
                            ConstNpc.IGNORE_MENU,
                            "Cần 100 Thỏi Vàng và 20.000 Hồng Ngọc",
                            "Đóng");
                    return;
                }
                ...
                this.baHatMit.createOtherMenu(player,
                        ...
                        "Ngươi có muốn nâng cấp thành Set Kích Hoạt?",
                        "Nâng cấp",
                        "Từ chối");
            ...
            case NANG_HUY_DIET_LEN_SKH_VIP:
                ...
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    String npcSay = "|2|Con có muốn đổi các món nguyên liệu ?\n|7|"
                            ...
                            + "|1|Cần " + Util.numberToMoney(50000000000L) + " vàng";
            ...
            case TAY_SKH_TRANG_BI:
                if (player.combineNew.itemsCombine.size() == 2) {
                    ...
                    if (dhd == null || buatay == null) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần Trang Bị Ấn và 30 Đá Ngũ Sắc", "Đóng");
                        return;
                    }
                    ...
                    if (dhd == null || buatay == null) {
                        ...
                        npcSay += "Ngươi có muốn tẩy ấn trang bị này không?\n";
                        if (player.inventory.gold >= 0) {
                            this.baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay, "Tẩy Ấn");
                        } else {
                            this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Chuẩn bị đủ tiền rồi hãy gặp ta!!!");
                        }
                    } else {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần Trang Bị Ấn và 30 viên Đá Ngũ Sắc", "Đóng");
                    }
                } else {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần Trang Bị Ấn và 30 viên Đá Ngũ Sắc", "Đóng");
                }
            ...
            case THANG_CAP_TRANG_BI:
                if (player.combineNew.itemsCombine.size() == 3) {
                    ...
                    if (Trangbi == null || DaBV == null || LuaThan == null) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần Trang Bị Thăng Cấp, Đá Bảo Vệ và Kết Ấn", "Đóng");
                    }

                    if (player.inventory.ruby < 50000) {
                        Service.getInstance().sendThongBao(player, "Chuẩn bị đủ 50K Hồng Ngọc hãy đến tìm ta");
                        return;
                        ...
                        if (player.inventory.ruby >= 50000) {
                            this.baHatMit.createOtherMenu(player, ConstNpc.MENU_START_COMBINE, npcSay, "Thăng Cấp\n Trang Bị");
                        } else {
                            this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, npcSay, "Chuẩn bị đủ tiền rồi hãy gặp ta!!!");
                        }
                    } else {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Ta cần Trang Bị Pha Lê Hóa 8 Sao", "Đóng");
                    }
                }
                break;
            ...
            case TAY_PS_HOA_TRANG_BI:
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    if (player.combineNew.itemsCombine.size() == 2) {
                        Item daHacHoa = null;
                        Item TrangBiHacHoa = null;
                        for (Item item_ : player.combineNew.itemsCombine) {
                            if (item_.template.id == 1649) {
                                daHacHoa = item_;
                            } else if (isTrangBiHacHoa(item_)) {
                                TrangBiHacHoa = item_;
                            }
                        }
                        if (daHacHoa == null) {
                        ...
                        String npcSay = "|2|Hiện tại " + TrangBiHacHoa.template.name + "\n|0|";
                        for (Item.ItemOption io : TrangBiHacHoa.itemOptions) {
                            if (io.optionTemplate.id != 72) {
                                npcSay += io.getOptionString() + "\n";
                            }
                        }
                        npcSay += "|2|Sau khi nâng cấp sẽ xoá hết các chỉ số pháp sư ngẫu nhiên \n|7|"
                                ...
                                + "Cần " + Util.numberToMoney(20000000000L) + " vàng";
            ...
            case PS_HOA_TRANG_BI:
                ...
                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                    if (player.combineNew.itemsCombine.size() == 2) {
                        ...
                        int currentLevel = 0;
                        for (ItemOption io : TrangBiHacHoa.itemOptions) {
                        ...
                        // Gán tỉ lệ nâng cấp giảm dần theo cấp
                        int baseRatio = 50;
                        int ratio = baseRatio - (currentLevel * 10);
                        player.combineNew.ratioCombine = Math.max(ratio, 10);
                        String npcSay = "|2|Hiện tại " + TrangBiHacHoa.template.name + "\n|0|";
                        for (Item.ItemOption io : TrangBiHacHoa.itemOptions) {
                            if (io.optionTemplate.id != 72) {
                                npcSay += io.getOptionString() + "\n";
                        ...
                        npcSay += "|2|Sau khi nâng cấp sẽ cộng 1 chỉ số pháp sư ngẫu nhiên \n|7|"
                                + "\n|7|Tỉ lệ thành công: " + player.combineNew.ratioCombine + "%\n"
                                + "Cần " + Util.numberToMoney(20000000000L) + " vàng " + " \nCần " + Util.numberToMoney(100000) + " Hồng ngọc ";
            ...
            case PHAN_RA_DO_THAN_LINH:
                ...
                if (player.combineNew.itemsCombine.size() == 1) {
                    ...
                    String npcSay = "|2|Sau khi phân rã vật phẩm\n|7|"
                            ...
                            + (500_000_000 > player.inventory.gold ? "|7|" : "|1|")
                            + "Cần " + Util.numberToMoney(500_000_000) + " vàng";
            ...
            case NANG_CAP_CHAN_MENH:
                if (player.combineNew.itemsCombine.size() == 0) {
                    this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                            "Hãy đưa ta chân thiên tử và 99 đá ngũ sắc ta sẽ phù phép cho !",
                            "Đóng");
                    return;
                }
                ...
                if (player.combineNew.itemsCombine.size() == 2) {
                    if (player.combineNew.itemsCombine.stream().filter(
                            ...
                            .count() < 1) {
                        this.baHatMit.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Thiếu chân thiên tử", "Đóng");
                        return;
                    }
                    if (player.combineNew.itemsCombine.stream()
                            .filter(item -> item.isNotNullItem() && item.template.id == 674)
            ...
            case CHE_TAO_TRANG_BI_TS:
                if (player.combineNew.itemsCombine.size() == 0) {
                    this.whis.createOtherMenu(player, ConstNpc.IGNORE_MENU, "Sao thế ku !", "Yes");
                    return;
                }
                if (player.combineNew.itemsCombine.size() >= 2 && player.combineNew.itemsCombine.size() < 5) {
                    ...
                    if (daNC != null) {
                        tilenew += (daNC.template.id - 1078) * 40;
                    }
                    ...
                    String npcSay = "|2|Chế tạo " + player.combineNew.itemsCombine.stream().filter(Item::isManhTS).findFirst().get().typeNameManh() + " Thiên sứ "
                            ...
                            + " (+" + (daNC.template.id - 1083) + "0% tỉ lệ thành công)\n"
...
//                    break;
    ...
    public void moChiSoCaiTrang(Player player) {
        ...
        if (caiTrang != null && longDen != null && longDen.quantity >= 99) {
            ...
            caiTrang.itemOptions.add(new ItemOption(50, Util.nextInt(20, 30)));
            caiTrang.itemOptions.add(new ItemOption(77, Util.nextInt(20, 30)));
            caiTrang.itemOptions.add(new ItemOption(103, Util.nextInt(20, 30)));
            caiTrang.itemOptions.add(new ItemOption(14, Util.nextInt(5, 15)));
            caiTrang.itemOptions.add(new ItemOption(5, Util.nextInt(10, 20)));
            caiTrang.itemOptions.add(new ItemOption(95, Util.nextInt(10, 20)));
            caiTrang.itemOptions.add(new ItemOption(96, Util.nextInt(10, 20)));
            caiTrang.itemOptions.add(new ItemOption(97, Util.nextInt(10, 20)));
            caiTrang.itemOptions.add(new ItemOption(98, Util.nextInt(10, 20)));
            caiTrang.itemOptions.add(new ItemOption(99, Util.nextInt(10, 20)));
...
//-------------------------------------------------------------------------------      
    ...
    private void dapDoKichHoatHD(Player player) {
        if (player.combineNew.itemsCombine.size() == 4) {
            ...
            if (dhdList.size() != 3 || dtl == null || dtl.quantity < 50) {
                Service.gI().sendThongBao(player, "Cần 3 đồ hủy diệt và 50 đá ngũ sắc");
                return;
            }
            Item tv = InventoryServiceNew.gI().findItemBag(player, 457);

            if (tv == null || tv.quantity < 100) {
                Service.gI().sendThongBao(player, "Không đủ 100 thỏi vàng");
                return;
            }
            if (player.inventory.ruby < 20000) {
                Service.gI().sendThongBao(player, "Không đủ 20k hồng ngọc");
                return;
            }
            if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 0) {
            ...
            Item item = dhdList.get(0);
            sendEffectSuccessCombine(player);

            RewardService.gI().initActivationOptionSKHHD(item.template.gender < 3 ? item.template.gender : player.gender,
                    item.template.type,
                    item.itemOptions);
            InventoryServiceNew.gI().addItemBag(player, item);

            dhdList.forEach(it -> InventoryServiceNew.gI().subQuantityItemsBag(player, it, 1));
            InventoryServiceNew.gI().subQuantityItemsBag(player, dtl, 50);
            InventoryServiceNew.gI().sendItemBags(player);
            Service.gI().sendMoney(player);
    ...
    private void TaySKH(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            ...
            InventoryServiceNew.gI().subQuantityItemsBag(player, buatay, 30);
            InventoryServiceNew.gI().sendItemBags(player);
            Service.getInstance().sendMoney(player);
            player.combineNew.itemsCombine.clear();
            reOpenItemCombine(player);
...
//            }           
    ...
    private void ThangCapTrangBi(Player player) {
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            if (Trangbi == null || DaBV == null || LuaThan == null) {
                Service.getInstance().sendThongBao(player, "Thiếu nguyên liệu nâng cấp");
                return;
            }

            if (player.inventory.ruby < 50000) {
                Service.getInstance().sendThongBao(player, "Bạn cần 50.000 Hồng Ngọc để nâng cấp");
                return;
            }

            int levelSao = 0;
            int levelNangCap = 0;
            Item.ItemOption optionSao = null;
            Item.ItemOption optionNangCap = null;

            for (Item.ItemOption io : Trangbi.itemOptions) {
                if (io.optionTemplate.id == 102) {
                    levelSao = io.param;
                    optionSao = io;
                } else if (io.optionTemplate.id == 216) {
                    levelNangCap = io.param;
                    optionNangCap = io;
                }
            }

            if (levelSao < 8) {
                Service.getInstance().sendThongBao(player, "Cần trang bị Pha Lê Hóa 8 Sao trở lên");
                return;
            }

            if (levelNangCap >= 7) {
                Service.getInstance().sendThongBao(player, "Trang bị đã đạt giới hạn thăng cấp (7 lần)");
                return;
            }

            if (DaBV.quantity < 50 || LuaThan.quantity < 50) {
                Service.getInstance().sendThongBao(player, "Không đủ 50 Đá Bảo Vệ hoặc 50 Kết Ấn");
                return;
            }

            // Trừ nguyên liệu
            InventoryServiceNew.gI().subQuantityItemsBag(player, DaBV, 50);
            InventoryServiceNew.gI().subQuantityItemsBag(player, LuaThan, 50);
            player.inventory.ruby -= 50000;

            // Tăng option thăng cấp
            ...
            // Thêm option mới theo tỉ lệ
            if (Util.isTrue(40, 100)) {
                Trangbi.itemOptions.add(new ItemOption(50, Util.nextInt(1, 6)));
                Trangbi.itemOptions.add(new ItemOption(77, Util.nextInt(1, 6)));
            } else if (Util.isTrue(30, 100)) {
                Trangbi.itemOptions.add(new ItemOption(195, 1));
                Trangbi.itemOptions.add(new ItemOption(103, Util.nextInt(1, 6)));
            } else if (Util.isTrue(20, 100)) {
                Trangbi.itemOptions.add(new ItemOption(196, 1));
                Trangbi.itemOptions.add(new ItemOption(50, Util.nextInt(1, 15)));
            } else {
                Trangbi.itemOptions.add(new ItemOption(77, Util.nextInt(1, 15)));
                Trangbi.itemOptions.add(new ItemOption(103, Util.nextInt(1, 15)));
            }

            sendEffectSuccessCombine(player);
            InventoryServiceNew.gI().sendItemBags(player);
            Service.getInstance().sendMoney(player);
            Service.getInstance().sendThongBao(player, "Thăng cấp trang bị thành công!");
    ...
    private void psHoaTrangBi(Player player) {
        ...
        for (Item item : player.combineNew.itemsCombine) {
            if (item != null && item.isNotNullItem()) {
                if (item.template.id == 1648) {
                    daPhapSu = item;
                } else if (isTrangBiHacHoa(item)) {
                    trangBi = item;
                }
            }
        }
        ...
        if (player.inventory.gold < COSTPS) {
        ...
        // Trừ nguyên liệu
        player.inventory.gold -= COSTPS;
        player.inventory.ruby -= RUBY;

        for (ItemOption itopt : trangBi.itemOptions) {
            if (itopt.optionTemplate.id == 223 && itopt.param >= 8) {
                Service.getInstance().sendThongBao(player, "Trang bị đã đạt tới giới hạn pháp sư");
                return;
            }
        }
        ...
        if (Util.isTrue(100, 100)) {
            ...
            if (!trangBi.haveOption(223)) {
                trangBi.itemOptions.add(new ItemOption(223, 1));
            } else {
                for (ItemOption itopt : trangBi.itemOptions) {
                    if (itopt.optionTemplate.id == 223) {
                        itopt.param += 1;
            ...
            if (!trangBi.haveOption(randomOption)) {
                trangBi.itemOptions.add(new ItemOption(randomOption, Util.nextInt(5, 10)));
            } else {
                for (ItemOption itopt : trangBi.itemOptions) {
                    if (itopt.optionTemplate.id == randomOption) {
                        itopt.param += Util.nextInt(3, 5);
                        break;
                    }
                }
            }
    ...
    private void nangCapSKHThuong(Player player) {
        if (!player.combineNew.itemsCombine.isEmpty()) {
            int gold = 5;
            Item thoivang = InventoryServiceNew.gI().findItemBag(player, 457);
            if (thoivang.quantity < 5) {
            ...
            if (isTrangBiGod1(item)) {
                if (player.gender == 3) {
                    ...
                    itemId = Manager.doSKHThuong[player.gender][item.template.type];
                }
                int skhId = ItemService.gI().randomSKHId(player.gender);
                Item itemSkh;
                itemSkh = ItemService.gI().itemSKH(itemId, skhId);
                ...
                if (thoivang.quantity <= 0) {
                    InventoryServiceNew.gI().removeItemBag(player, thoivang);
                }
                InventoryServiceNew.gI().sendItemBags(player);
                Service.getInstance().sendMoney(player);
                reOpenItemCombine(player);
    ...
    private void nangKichHoatVip(Player player) {
        if (!player.combineNew.itemsCombine.isEmpty()) {
            ...
            Item item2 = player.combineNew.itemsCombine.get(2);
            short itemId;
            if (isTrangBiGod1(item) && isTrangBiGod1(item1) && isTrangBiGod1(item2)) {
                if (player.gender == 3 || item.template.type == 4) {
                    itemId = Manager.radaSKHVip[Util.nextInt(0, 5)];
                    if (Util.isTrue(1, (int) 2000)) {
                        itemId = Manager.radaSKHVip[6];
                    }
                } else {
                    itemId = Manager.doSKHVip[player.gender][item.template.type][Util.nextInt(0, 5)];
                    if (Util.isTrue(1, (int) 2000)) {
                        itemId = Manager.doSKHVip[player.gender][item.template.type][6];
                    }
                }
                int skhId = ItemService.gI().randomSKHId(player.gender);
                Item newItem;
                if (new Item(itemId).isDTL()) {
                    ...
                    newItem.itemOptions.remove(item.itemOptions.stream().filter(itemOption -> itemOption.optionTemplate.id == 21).findFirst().get());
    ...
    private void nangKichHoatVip2(Player player) {
        if (!player.combineNew.itemsCombine.isEmpty()) {
            ...
            if (isTrangBiHakai(item) && isTrangBiHakai(item1) && isTrangBiHakai(item2) && isTrangBiHakai(item3) && isTrangBiHakai(item4) && isTrangBiHakai(item5) && isTrangBiHakai(item6) && isTrangBiHakai(item7) && isTrangBiHakai(item8) && isTrangBiHakai(item9)) {
                ...
                //if ( isTrangBiGod1(item))   
                int idItemKichHoatTDop[][] = {{555},
                {556},
                {562},
                {563},
                {561}};
                int idItemKichHoatNMop[][] = {{557},
                {558},
                {564},
                {565},
                {561}};
                int idItemKichHoatXDop[][] = {{559},
                {560},
                {566},
                {567},
                {561}};
                int optionItemKichHoat[][] = {{127, 128, 129, 140, 139, 141}, {130, 131, 132, 142, 143, 144}, {133, 134, 135, 136, 137, 138}};
                ...
                if (gender == 0) {
                    ...
                    if (itemKichHoat.template.id == 562) {
                        itemKichHoat.itemOptions.add(new Item.ItemOption(0, (Util.nextInt(35, 55)) * 100));
                    }
                ...
                if (gender == 1) {
                    ...
                    if (itemKichHoat.template.id == 564) {
                        itemKichHoat.itemOptions.add(new Item.ItemOption(0, (Util.nextInt(37, 67)) * 100));
                    }
                ...
                if (gender == 2) {
                    ...
                    if (itemKichHoat.template.id == 566) {
                        itemKichHoat.itemOptions.add(new Item.ItemOption(0, (Util.nextInt(40, 60)) * 100));
                    }
                    //giay{27, 30, 39, 40, 148, 149, 150, 151, 266, 267, 268, 269},
                ...
                InventoryServiceNew.gI().removeItemBag(player, item5);
                InventoryServiceNew.gI().removeItemBag(player, item6);
                InventoryServiceNew.gI().removeItemBag(player, item7);
                InventoryServiceNew.gI().removeItemBag(player, item8);
                InventoryServiceNew.gI().removeItemBag(player, item9);
    ...
    private void tayHacHoaTrangBi(Player player) {
        ...
        if (trangBiHacHoa == null || daPhapSu == null) {
            Service.getInstance().sendThongBao(player, "Thiếu trang bị hắc hóa hoặc đá pháp sư");
            return;
        }
        ...
        if (Util.isTrue(100, 100)) {
            ...
            // Xoá các option liên quan đến pháp sư hóa
            trangBiHacHoa.itemOptions.removeIf(io -> io.optionTemplate.id == 223
                    || io.optionTemplate.id == 219
                    || io.optionTemplate.id == 220
                    || io.optionTemplate.id == 221
                    || io.optionTemplate.id == 222);

            Service.getInstance().sendThongBao(player, "Tẩy pháp sư hóa thành công!");
        } else {
            sendEffectFailCombine(player);
        }
        ...
        // Cập nhật túi đồ và dọn nguyên liệu
        InventoryServiceNew.gI().sendItemBags(player);
        Service.getInstance().sendMoney(player);
        player.combineNew.itemsCombine.clear();
        reOpenItemCombine(player);
...
//    
    ...
    public void cheTaoDoTS(Player player) {
        List<Item> itemsAll = player.combineNew.itemsCombine;
        // Lấy danh sách chỉ những ô có item thật sự (không phải null/placeholder)
        List<Item> items = itemsAll.stream()
                .filter(it -> it != null && it.isNotNullItem())
                .collect(Collectors.toList());

        // Kiểm tra số lượng vật phẩm (dùng số lượng item thực tế)
        if (items.size() < 2 || items.size() > 4) {
            Service.getInstance().sendThongBao(player, "Thiếu vật phẩm, vui lòng thêm vào");
            return;
        }

        long countCtVip = items.stream().filter(item -> item.isCongThucVip()).count();
        long countManhTS = items.stream().filter(item -> item.isManhTS() && item.quantity >= 999).count();
        long countDaNC = items.stream().filter(item -> item.isDaNangCap()).count();
        long countDaMM = items.stream().filter(item -> item.isDaMayMan()).count();
        ...
        // nếu số item là 3 hoặc 4 thì bắt buộc có đá nâng cấp
        if ((items.size() == 3 || items.size() == 4) && countDaNC != 1) {
            Service.getInstance().sendThongBao(player, "Thiếu Đá nâng cấp");
            return;
        }
        // nếu số item là 3 hoặc 4 thì bắt buộc có đá may mắn
        if ((items.size() == 3 || items.size() == 4) && countDaMM != 1) {
            Service.getInstance().sendThongBao(player, "Thiếu Đá may mắn");
            return;
        }

        // Lấy reference các item (từ danh sách items - đã lọc)
        Item mTS = items.stream().filter(item -> item.isManhTS() && item.quantity >= 999).findFirst().orElse(null);
        Item daNC = items.stream().filter(item -> item.isDaNangCap()).findFirst().orElse(null);
        Item daMM = items.stream().filter(item -> item.isDaMayMan()).findFirst().orElse(null);
        Item CtVip = items.stream().filter(item -> item.isCongThucVip()).findFirst().orElse(null);

        // Kiểm tra ô trống hành trang & tiền
        if (InventoryServiceNew.gI().getCountEmptyBag(player) <= 0) {
            Service.getInstance().sendThongBao(player, "Bạn phải có ít nhất 1 ô trống hành trang");
            return;
        }
        if (player.inventory.gold < 1000000000 || player.inventory.ruby < 10000) {
        ...
        // Tính tỉ lệ theo logic cũ
        int tilemacdinh = 70;
        int tileLucky = 30;
        if (daNC != null) {
            tilemacdinh += (daNC.template.id - 1078) * 30;
        }
        if (daMM != null) {
            tileLucky += tileLucky * (daMM.template.id - 1083) * 30 / 100;
        }

        // Kiểm tra thành công chính (giữ nguyên điều kiện < tilemacdinh như cũ)
        if (Util.nextInt(0, 100) < tilemacdinh) {
            Item itemCtVip = items.stream().filter(item -> item.isCongThucVip()).findFirst().get();
            Item itemDaNangC = daNC != null ? items.stream().filter(item -> item.isDaNangCap()).findFirst().orElse(null) : null;
            Item itemDaMayM = daMM != null ? items.stream().filter(item -> item.isDaMayMan()).findFirst().orElse(null) : null;
            Item itemManh = items.stream().filter(item -> item.isManhTS() && item.quantity >= 999).findFirst().get();

            // Giữ nguyên mapping tilemacdinh cũ (random trong 0..50 rồi chuyển thành 0..20 theo chuỗi if)
            ...
            Item itemTS = ItemService.gI().DoThienSu(itemIds[genderIndex][itemManh.typeIdManh()], itemCtVip.template.gender);

            // tăng param theo phần trăm
            tilemacdinh += 10;
            if (tilemacdinh > 0) {
                for (byte i = 0; i < itemTS.itemOptions.size(); i++) {
                    ItemOption opt = itemTS.itemOptions.get(i);
                    if (opt.optionTemplate.id != 21 && opt.optionTemplate.id != 30) {
                        opt.param += (opt.param * tilemacdinh / 100);
                    }
                }
            }

            // Lucky options (giữ logic cũ)
            ...
            if (tilemacdinh <= tileLucky) {
                ...
                for (int i = 0; i < tileLucky; i++) {
                    int idx = Util.nextInt(0, listOptionBonus.size());
                    itemTS.itemOptions.add(new ItemOption(listOptionBonus.get(idx), Util.nextInt(5, 20)));
                    listOptionBonus.remove(idx);
                }
            }
        ...
        // Trừ vật phẩm theo từng trường hợp (giữ logic trừ như cũ)
...
//    }
    ...
    public void nangCapChanMenh(Player player) {
        ...
        if (player.combineNew.itemsCombine.stream()
                ...
                .count() != 1) {
            Service.gI().sendThongBao(player, "Chân thiên tử");
            return;
        }
        if (player.combineNew.itemsCombine.stream().filter(item -> item.isNotNullItem() && item.template.id == 674)
                .count() != 1) {
        ...
        if (chanMenh != null && ngoc1sao != null && ngoc1sao.quantity >= 99 && player.inventory.ruby > 50000) {
            player.inventory.ruby -= 50000;
            player.inventory.gem -= 0;
            ...
            if (Util.isTrue(1, 100)) {
                chanMenhMoi.itemOptions.add(new ItemOption(50, 4 + capChanMenh * 2));
            }
            chanMenhMoi.itemOptions.add(new ItemOption(77, 4 + capChanMenh * 2));
            chanMenhMoi.itemOptions.add(new ItemOption(103, 4 + capChanMenh * 2));
            chanMenhMoi.itemOptions.add(new ItemOption(5, 4 + capChanMenh));
            chanMenhMoi.itemOptions.add(new ItemOption(14, 4 + capChanMenh));
    ...
    private void nangCapBongTai(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            ...
            if (bongTai != null && manhVo != null && manhVo.quantity >= 500) {
                ...
                boolean isSuccess = Util.isTrue(player.combineNew.ratioCombine, 100);
                if (isSuccess) {
                ...
                // Trừ đúng 500 mảnh sau khi biết kết quả
                ...
                if (!star) {
                    ...
                    if (Util.isTrue(100, 100)) {
                        if (trangBi.template.gender == 0) {
                            trangBi.itemOptions.add(new Item.ItemOption(Util.nextInt(34, 36), 0));
        ...
        if (player.combineNew.itemsCombine.size() == 3) {
            ...
            if (bongtai != null && honbongtai != null && honbongtai.quantity >= 99) {
                ...
                if (Util.isTrue(player.combineNew.ratioCombine, 100)) {
                    ...
                    if (rdUp == 0) {
                        bongtai.itemOptions.add(new Item.ItemOption(50, Util.nextInt(2, 10)));
                    } else if (rdUp == 1) {
                        bongtai.itemOptions.add(new Item.ItemOption(77, Util.nextInt(2, 10)));
                    } else if (rdUp == 2) {
                        bongtai.itemOptions.add(new Item.ItemOption(103, Util.nextInt(2, 10)));
                    } else if (rdUp == 3) {
                        bongtai.itemOptions.add(new Item.ItemOption(108, Util.nextInt(2, 10)));
                    } else if (rdUp == 4) {
                        bongtai.itemOptions.add(new Item.ItemOption(94, Util.nextInt(2, 10)));
                    } else if (rdUp == 5) {
                        bongtai.itemOptions.add(new Item.ItemOption(14, Util.nextInt(2, 10)));
                    } else if (rdUp == 6) {
                        bongtai.itemOptions.add(new Item.ItemOption(80, Util.nextInt(2, 10)));
                    } else if (rdUp == 7) {
                        bongtai.itemOptions.add(new Item.ItemOption(81, Util.nextInt(2, 10)));
                    }
                    sendEffectSuccessCombine(player);
                } else {
                    sendEffectFailCombine(player);
    ...
    private void nangCapBongTaicap3(Player player) {
        if (player.combineNew.itemsCombine.size() == 2) {
            ...
            if (bongTai != null && manhVo != null && manhVo.quantity >= 1000) {
                ...
                // Chỉ trừ 1 lần, sau khi xác định thành bại
        ...
        if (!player.combineNew.itemsCombine.isEmpty()) {
            ...
            if (isTrangBiGod1(item)) {
                ...
                if (Util.isTrue(50, 100)) {
                    ...
                    itemKichHoat.itemOptions.add(new ItemOption(21, 80));
                    itemKichHoat.itemOptions.add(new ItemOption(30, 0));
                    InventoryServiceNew.gI().addItemBag(player, itemKichHoat);
                    sendEffectCombineDB(player, item.template.iconID);
                } else {
...
//            int thoivang = 10;
            ...
            if (trangBi != null && isTrangBiGod(trangBiGod)) {
                ...
                if (star < MAX_LEVEL_PET) {
                    ...
                    int param;
                    if (trangBiGod.template.type == 0 || trangBiGod.template.type == 4) {
                        param = 2;
                    } else {
                        param = 1;
                    }
...
//                
    ...
    private boolean isDaPhaLe(Item item) {
        return item != null && (item.template.type == 30 || (item.template.id >= 14 && item.template.id <= 20) || (item.template.id >= 925 && item.template.id <= 931));
    }
    ...
    private boolean isTrangBiAn(Item item) {
        if (item != null && item.isNotNullItem()) {
            if (item.template.id >= 1048 && item.template.id <= 1062 || item.template.id >= 555 && item.template.id <= 567 || item.template.id >= 650 && item.template.id <= 662) {
                return true;
            } else {
                return false;
            }
    ...
    private boolean isTrangBiHacHoa(Item item) {
        if (item != null && item.isNotNullItem()) {
            int type = item.template.type;
            // 0: Áo, 1: Quần, 2: Găng, 3: Giày, 4: Radar, 5: Vũ khí, 32: Cải trang
    ...
    private String getNameItemC2(int gender, int type) {
        if (type == 4) {
    ...
    private int getParamDaKhamHPMP(int star) {
        switch (star) {
            ...
            case 1:
                return 120000; // ki
            case 2:
                return 140000; // hp 30s
            case 3:
                return 160000; // hp
            case 4:
                return 180000; // ki
            case 5:
                return 200000; // hp 30s
            case 6:
                return 220000; // hp
            case 7:
                return 240000; // ki
            case 8:
                return 260000; // hp 30s
            case 9:
                return 300000; // hp
            default:
                return -1;
    ...
    public Item randomCS_DHD(int itemId, int gender) {
        Item it = ItemService.gI().createNewItem((short) itemId); // tạo item trắng theo id
        ...
        if (ao.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(47, Util.highlightsItem(gender == 2, rd.nextInt(1001) + 1800)));
        }
        if (quan.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(22, Util.highlightsItem(gender == 2, rd.nextInt(16) + 85)));
        }
        if (gang.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(0, Util.highlightsItem(gender == 0, rd.nextInt(150) + 8500)));
        }
        if (giay.contains(itemId)) {
            it.itemOptions.add(new Item.ItemOption(23, Util.highlightsItem(gender == 1, rd.nextInt(11) + 80)));
        }
        if (nhd == itemId) {
            it.itemOptions.add(new Item.ItemOption(14, rd.nextInt(3) + 17));
        }
    ...
    private String getTextTopTabCombine(int type) {
        switch (type) {
            ...
            case kh_Ts:
                return "Ta sẽ giúp ngươi\n làm điều đó";
            case PHAN_RA_DO_THAN_LINH:
                return "Ta sẽ phân rã \n  trang bị của người thành Đá Ngũ Sắc!";
            case NANG_CAP_DO_TS:
        ...
        switch (type) {
            ...
            case kh_Ts:
                return "Vào hành trang\nChọn 2 trang bị Thiên Sứ bất kì\n "
                        ...
                        + "Chỉ cần chọn 'Nâng Cấp'";
            case PS_HOA_TRANG_BI:
                return "Vào hành trang\nChọn trang bị từ Áo - Giáp Luyện Tập và đá pháp sư \n "
                        + " để nâng cấp chỉ số pháp sư\n"
                        + "Chỉ cần chọn 'Nâng Cấp'";
            case TAY_PS_HOA_TRANG_BI:
                return "Vào hành trang\nChọn 1 trang bị Pháp Sư và bùa giải pháp sư \n "
            ...
            case DAP_SET_KICH_HOAT_HD:
                return "Cần 3 Trang Bị Hủy Diệt bất kỳ và 50 Đá Ngũ Sắc\n"
                        + "Nâng cấp cần 100 thỏi vàng + 20k hồng ngọc\n"
                        + "Sau đó chọn 'Nâng cấp'";
            case DAP_SET_KICH_HOAT_TS:
            ...
            case TAY_SKH_TRANG_BI:
                return "Cần 1 Trang Bị Ấn ( Thần Linh, Hủy Diệt, Thiên Sứ và 30 Đá Ngũ Sắc )"
                        + "\nSau đó chọn 'Tẩy Ấn'";
            case KHAC_CHI_SO_DA:
            ...
            case THANG_CAP_TRANG_BI:
                return "Cần 1 Trang Bị 8 Sao, 50 Đá Bảo Vệ và 50 Kết Ấn"
            ...
            case MO_CHI_SO_CAI_TRANG:
                return "Vào hành trang\n"
                        ...
                        + "\n\n\n"
                        + "-----CHÚ Ý-----\n"
                        + "Khi tinh luyện cải trang các chỉ số cũ sẽ biến mất hoàn toàn "
                        + "\n và thay bằng chuỗi chỉ số ngẫu nhiên";
            case THUC_TINH_DT:
            ...
            case NANG_CAP_PK:
                return "Vào hành trang\n"
                        ...
                        + "Chúc nhà ngươi may mắn.";
            case CUONG_HOA:
                return "Vào hành trang chọn trang bị Thần Linh trở lên\n"
                        + "-------Lưu ý-------\n"
                        + "cần 20 viên Đá ngọc bảo trong hành trang\n"
                        + "Sau đó chọn 'Nâng cấp'\n"
                        + "Ra Ấn Ngẫu Nhiên\n"
                        + "Set Tinh Ấn +30% HP\n"
                        + "Set Nhật Ấn +30% KI\n"
                        + "Set Nguyệt Ấn +20% SĐ\n";
            case NANG_CAP_SKH_THUONG:
                return "Chọn 1 trang bị Thần Linh vào 1 ô\n Nâng cấp cần 5 thỏi vàng\nSau đó chọn 'Nâng cấp'\n";
            case NANG_KICH_HOAT_VIP:
                return "Chọn 3 trang bị Thần Linh cho vào 3 ô \n Nâng cấp cần 10 thỏi vàng\nSau đó chọn 'Nâng cấp'\n";
            case NANG_KICH_HOAT_VIP2:
                return "Chọn 10 trang bị Hủy Diệt cho vào 10 ô \n Nâng cấp cần 10 thỏi vàng + 10K Hồng Ngọc\nHãy xếp theo thứ tự\nSau đó chọn 'Nâng cấp'\nMay mắn nhận được cực phẩm";
