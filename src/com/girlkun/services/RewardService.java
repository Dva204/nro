...
public class RewardService {
    ...
    private static final int[][][] ACTIVATION_SET = {
        {{129, 141, 1000, 1000}, {127, 140, 1000, 1000}, {128, 139, 1000, 1000}}, //songoku - thien xin hang - kirin
    ...
    public void initActivationOptionSKHHD(int gender, int type, List<Item.ItemOption> list) {
        if (type <= 4) {
            ...
            int[] idOption = ACTIVATION_SET[gender][index];

            list.add(new Item.ItemOption(idOption[0], 1));
            list.add(new Item.ItemOption(idOption[1], 1));
            list.add(new Item.ItemOption(30, 7));
        }
    }
