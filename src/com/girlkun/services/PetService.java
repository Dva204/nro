...
public class PetService {
    ...
    public void createPetPiccolo(Player player, boolean isChange, byte gender) {
        byte limitPower;
        if (isChange) {
            limitPower = player.pet.nPoint.limitPower;
            if (player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
        ...
        new Thread(() -> {
            try {
                ...
                player.pet.nPoint.limitPower = limitPower;
                Thread.sleep(1000);
                Service.getInstance().chatJustForMe(player, player.pet, "Ma Vương Tái Thế...");
            } catch (Exception e) {
            }
        }).start();
    }
    
    public void createPetVegito(Player player, boolean isChange, byte gender) {
        byte limitPower;
        if (isChange) {
            limitPower = player.pet.nPoint.limitPower;
            if (player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
        ...
        new Thread(() -> {
            try {
                ...
                player.pet.nPoint.limitPower = limitPower;
                Thread.sleep(1000);
                Service.getInstance().chatJustForMe(player, player.pet, "Ta đến để dẹp loạn...");
            } catch (Exception e) {
            }
        }).start();
    }
    
    public void createPetGogeta(Player player, boolean isChange, byte gender) {
        byte limitPower;
        if (isChange) {
            limitPower = player.pet.nPoint.limitPower;
            if (player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
        ...
        new Thread(() -> {
            try {
                ...
                player.pet.nPoint.limitPower = limitPower;
                Thread.sleep(1000);
                Service.getInstance().chatJustForMe(player, player.pet, "tập luyện chính là sức mạnh...");
            } catch (Exception e) {
            }
        }).start();
    }
    
    public void createPetGokuBNVC(Player player, boolean isChange, byte gender) {
        byte limitPower;
        if (isChange) {
            limitPower = player.pet.nPoint.limitPower;
            if (player.fusion.typeFusion != ConstPlayer.NON_FUSION) {
