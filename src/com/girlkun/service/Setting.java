...
public class Setting {
    ...
    // ------------------------- server setting -------------------------
    public static final int PORT = 1404;
    public static final int MAX_IP = 3;
    public static final int PLAYER_ID = 0;

    public static boolean IN_LOG = true;

    public static String LIST_SERVER = "LMVT:103.249.117.96:1404:0,0,0";
    public static String SERVER_NAME = "LMVT:103.249.117.96:1404:0,0,0"; // ch

    // -------------------------- sql setting ----------------------------
    public static final String DB_HOST = "103.249.117.96";
    public static final String DB_DATE = "nro_data";
    public static final String DB_NICK = "nro_acc";
    public static final String DB_USER = "root";
    public static final String DB_PASS = "";

    public static final int MAX_PLAYER = 9999;
    ...
    public static final int DONATE_EXP = 1; // exp sv hiện tại là x10( tnsm khi up ấy )
    ...
    public static final int MAX_SMALL = 99999;
    ...
    // hirudegarn
     ...
     public static final byte TIME_END_HIRU_1 = 23;
     public static final byte TIME_END_HIRU_2 = 23;
    // osin mabu
    public static final byte TIME_START_OSIN_1 = 12;
    public static final byte TIME_START_OSIN_2 = 18;
    public static boolean START_OSIN = true;
