        ...
        try (Connection con = GirlkunDB.getConnection();) {
            ...
            dataPoint = GirlkunDB.executeQuery("select * from a_server_sukien where id_event = ?", 7);
                if (dataPoint.first()) {
                    ...
                    NauBanh n = NauBanh.gI();
n.Count = Integer.parseInt(String.valueOf(dataPointEvent.get(1)));
n.Nuoc = Float.parseFloat(String.valueOf(dataPointEvent.get(2)));
n.Cui = Integer.parseInt(String.valueOf(dataPointEvent.get(3)));
X2 = Long.parseLong(String.valueOf(dataPointEvent.get(4)));
    ...
    public void close() {
        try {
            ...
            NauBanh n = NauBanh.gI();
            dataArray.add(n.Count);
            dataArray.add(n.Nuoc);
            dataArray.add(n.Cui);
