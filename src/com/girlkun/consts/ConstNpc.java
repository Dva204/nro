...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "2 sao : Tăng 30% HP\n"
            + "3 sao : Hút 10% HP\n"
            + "4 sao : Phản 25% Sát Thương\n"
            + "5 sao : Tăng 20% Sức Đánh Chí Mạng\n"
            + "6 sao : Tăng 33% KI\n"
            + "7 sao : Tăng 15% Né Đòn";
    ...
    public static final String HUONG_DAN_MOC_NAP = "|1|Mốc 10K: 10V 3sao\b|1|Mốc 20K: 20v 3sao, 20v 7sao\b|1|Mốc 50K: Cải trang Zamatsu, Linh Thú, Tuần Lộc\b|1|Mốc 100K: 1 Set Kích Hoạt thường, 3 bộ nro\b|1|Mốc 200k: Kiếm, x99(cn,bh,gx,bk)\b|1|Mốc 500K: Cải trang NROAS lục đạo, x2000 viên đá các loại\b|1|Mốc 1000K: Meow tà ác, cải trang Majin Form, Xe tăng, x99 3sao";
    ...
    public static final String AN_TRANG_BI_HUONG_DAN = "dùng Đá ngọc bảo giúp nâng cấp Trang bị thường lên trang bị ẤN\n"
            ...
            + "Đá ngọc bảo có thể tìm kiếm bằng cách tiêu diệt quân đội DOREMON\n"
    ...
    public static final byte MEC = 84;
    ...
    //public static final byte TORI = 118;
    ...
    public static final int QUY_DOI_XU_BAC = 880;
    public static final int QUY_DOI_XU_VANG = 881;
    public static final int QUY_DOI_TIEN = 882;
    public static final int QUY_DOI_DBV = 883;
    public static final int NAP_TIEN = 884;
    public static final int RUT_TIEN = 885;
    public static final int TIEN_TO_VND = 886;
    public static final int TV_TO_VND = 887;
