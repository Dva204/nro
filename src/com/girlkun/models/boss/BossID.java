...
public class BossID {
    ...
    public static final int KUKU = -999;
    public static final int MAP_DAU_DINH = -998;
    public static final int RAMBO = -997;
    public static final int CADIC1 = -996;
    public static final int CADIC2 = -1000;
    public static final int CADICTL = -995;
    public static final int ZAMAS2025 = -992;
    public static final int PICOLO = -991;
    public static final int BABY = -9909;
    public static final int SHENRON = -9908;
    public static final int FIDEGOLD = -9907;
    public static final int ZAMAS1 = -9906;
    public static final int BLACKGOKU = -9905;

//  
    public static final int BACON = -990;
