...
public class BossHoaTinh extends Boss {
    ...
    public void reward(Player plKill) {
        ...
        int a = 0;
        for (int i = 0; i < 10; i++) {
            ItemMap it1 = new ItemMap(this.zone, 1614, 1, this.location.x + a, this.zone.map.yPhysicInTop(this.location.x,
        ...
        for (int i = 0; i < 5; i++) {
            ItemMap it2 = new ItemMap(this.zone, 1615, 1, this.location.x + a, this.zone.map.yPhysicInTop(this.location.x,
                    this.location.y - 24), -1);
        ...
        if (plKill != null) {
            ...
            capsuleTT.template = ItemService.gI().getTemplate(1614);
            capsuleTT.quantity = 5;
            InventoryServiceNew.gI().addItemBag(plKill, capsuleTT);
            Item Duoikhi = new Item();
            Duoikhi.template = ItemService.gI().getTemplate(1615);
            Duoikhi.quantity = 10;
        ...
        for (int i = 0; i < this.PlayerPlAtt.size(); i++) {
            ...
            if (pl != null && pl.zone != null && pl.zone.map.mapId == 184
                ...
                if (ptnhanqua >= 3 && ptnhanqua <= 3) {
                    ...
                    Service.gI().sendThongBaoOK(pl, "Bạn nhận được Đá Ngũ Sắc thưởng tham gia sự kiện ");
                    pl.DucNTdamethanmeo = 0;
