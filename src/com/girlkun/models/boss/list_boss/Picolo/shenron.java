...
public class shenron extends Boss {

    public shenron() throws Exception {
        super(BossID.SHENRON, BossesData.SHENRON);
    }
    ...
    public void reward(Player plKill) {
        ...
        if (Util.isTrue(80, 100)) {
            ItemMap it = new ItemMap(this.zone, 674, 2, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
