...
@Override
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ...
            it.options.add(new Item.ItemOption(50, Util.nextInt(5, 40)));
            it.options.add(new Item.ItemOption(77, Util.nextInt(5, 40)));
            it.options.add(new Item.ItemOption(103, Util.nextInt(5, 40)));
