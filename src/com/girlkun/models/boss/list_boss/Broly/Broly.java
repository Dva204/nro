...
public class Broly extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            this.nPoint.hpMax = 49876543;
            if (this.nPoint.hp <= 0) {
                BossData superBrolyData = new BossData(
                        "Super Broly " + Util.nextInt(100),
                        this.gender,
                        new short[]{1952, 1955, 1956, 202, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
                        Util.nextInt(100000, 200000), //dame
                        new long[]{Util.nextInt(10000000, 49876543)}, //hp
                ...
                if (player == null) {
                    ...
                    if (Util.isTrue(100, 100)) {
                        BossData Super = new BossData(
                                "Super Broly " + Util.nextInt(100),
                                this.gender,
                                new short[]{1916, 1919, 1920, -1, -1, -1},
                                Util.nextInt(100000, 200000),
                                new long[]{Util.nextInt(10000000, 49876543)},
                                new int[]{6, 27, 28, 29, 30, 13, 31, 32, 33, 34, 10, 19, 20, 35, 36, 37, 38},
                                new int[][]{
                                    {Skill.ANTOMIC, 7, 100}, {Skill.MASENKO, 7, 100},
                                    {Skill.KAMEJOKO, 7, 100},
                                    {Skill.TAI_TAO_NANG_LUONG, 5, 15000}},
