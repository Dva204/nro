...
public class BossesData {
    ...
    private static final int[][] FULL_DE_TRUNG = new int[][]{{Skill.DE_TRUNG, 1}, {Skill.DE_TRUNG, 2}, {Skill.DE_TRUNG, 3}, {Skill.DE_TRUNG, 4}, {Skill.DE_TRUNG, 5}, {Skill.DE_TRUNG, 6}, {Skill.DE_TRUNG, 7}};
    ...
    //**************************************************************************cha con fide
    public static final BossData ZAMASTL = new BossData(
            "Tử Thần Black Rose",
            ConstPlayer.XAYDA,
            new short[]{1942, 1945, 1946, 201, -1, -1},
            300000,
            new long[]{2100000000L},
            ...
            new int[][]{
                ...
                {Skill.THAI_DUONG_HA_SAN, 1, 35000},
                {Skill.LIEN_HOAN, 7, 10000}},//skill
            new String[]{"|-2|Hắn ta là ai vậy?"}, //text chat 1
            new String[]{"|-1|Là tao đây",
                "|-1|Hành tinh mày chuẩn bị chết đi!",
                "|-2|Là mày à tên khốn",
                "|-1|Mày sẽ không bao giờ thắng được đâu!!",
                "|-2|Hắn mạnh hơn trước",}, //text chat 2
            new String[]{"|-1|Xin hãy tha cho ta !",
                "|-1|Ta sẽ cho ngươi thành thần!",
                "|-1|Đừng màaa!"}, //text chat 3
            REST_15_M, //second rest
            new int[]{BossID.BLACKGOKU}
    );

    public static final BossData BLACKROSE = new BossData(
            "Tử Thần Zamas", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1762, 1763, 1764, 199, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            80000, //dame
            new long[]{2100000000L}, //hp
            new int[]{225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236, 237}, //map join
            new int[][]{
                {Skill.ANTOMIC, 1, 13}, {Skill.ANTOMIC, 2, 14}, {Skill.ANTOMIC, 3, 15}, {Skill.ANTOMIC, 4, 16}, {Skill.ANTOMIC, 5, 17}, {Skill.ANTOMIC, 6, 19}, {Skill.ANTOMIC, 7, 20},
                {Skill.MASENKO, 1, 21}, {Skill.MASENKO, 5, 22}, {Skill.MASENKO, 6, 23},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 10000},
    ...
    //----------------------------------------------Cadic
    public static final BossData SHENRON = new BossData(
            "Omega Shenron", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1336, 1337, 1338, 191, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            345000, //dame
            new long[]{2000000000L}, //hp
            new int[]{239, 244}, //map join
            (int[][]) Util.addArray(FULL_ANTOMIC, FULL_GALICK, FULL_DRAGON, FULL_KAMEJOKO, FULL_ANTOMIC), //skill
            new String[]{"|-1|Ngọc Rồng",
                "|-1|Tại sao tao lại ở đây!",
                "|-2|Mày là quái vật!",
                "|-1|Mày làm tao phấn khích rồi đấy hahaha.."
            }, //text chat 1
            new String[]{"|-1|Tao nhớ rồi",
                "|-1|Ha ha ha!!!",
                "|-1|Định chạy trốn hả",
            ...
            // TypeAppear.CALL_BY_ANOTHER //second rest
            REST_15_M
    );
    //----------------------------------------------Cadic
    public static final BossData BABY1 = new BossData(
            "Baby Ngoại Lai", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1847, 1848, 1849, 198, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            345000, //dame
            new long[]{2050000000L}, //hp
            new int[]{232, 233}, //map join
            new int[][]{
                {Skill.ANTOMIC, 1, 13}, {Skill.ANTOMIC, 2, 14}, {Skill.ANTOMIC, 3, 15}, {Skill.ANTOMIC, 4, 16}, {Skill.ANTOMIC, 5, 17}, {Skill.ANTOMIC, 6, 19}, {Skill.ANTOMIC, 7, 20},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 10000},
                //{Skill.DE_TRUNG, 5, 15000},
                {Skill.LIEN_HOAN, 7, 10000}},//skill
            new String[]{"|-1|Gặp lại bạn cũ rồi",
                "|-1|Tại sao lại muốn mạnh lên!",
                "|-2|Tao chỉ biết từ lúc đó tao đã thay đổi!",
                "|-1|Mày làm tao phấn khích rồi đấy hahaha.."
            }, //text chat 1
            new String[]{"|-1|Tao hơn hẳn mày, mày nên cầu cho may mắn ở phía mày đi",
                ...
                "|-1|Ta sẽ tàn sát khu này trong vòng 5 phút nữa",
                "|-1|Hahaha mày đây rồi",
                "|-1|Tao đã có lệnh từ đại ca Omega rồi"
            }, //text chat 2
            new String[]{"|-2|Đẹp trai nó phải thế"}, //text chat 3
            // TypeAppear.CALL_BY_ANOTHER //second rest
            REST_15_M
    ...
    public static final BossData BABY2 = new BossData(
            "Baby Monkey", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1850, 1851, 1852, 198, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            345000, //dame
            new long[]{2100000000L}, //hp
            new int[]{232, 233}, //map join
            new int[][]{
                ...
                {Skill.LIEN_HOAN, 7, 10000}},//skill,//skill //skill
            new String[]{"|-1|Tao là Super Monkey",
                "|-2|Mày chỉ là thứ nhân tạo!",
                "|-1|Lắm mồm?"
            }, //text chat 1
            new String[]{"|-1|Chết hết đi cho tao",
                ...
                "|-2|Muốn đùa dỡn à!",
                "|-2|tao nhịn mày lâu lắm rồi ấy nhá",
    ...
    public static final BossData PIKKON = new BossData(
            ...
            new short[]{1853, 1856, 1857, 191, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            345000, //dame
            new long[]{2000000000L}, //hp
            new int[]{231}, //map join
            new int[][]{
                {Skill.ANTOMIC, 1, 13}, {Skill.ANTOMIC, 2, 14}, {Skill.ANTOMIC, 3, 15}, {Skill.ANTOMIC, 4, 16}, {Skill.ANTOMIC, 5, 17}, {Skill.ANTOMIC, 6, 19}, {Skill.ANTOMIC, 7, 20},
                {Skill.MASENKO, 1, 21}, {Skill.MASENKO, 5, 22}, {Skill.MASENKO, 6, 23},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 10000},
            ...
            new String[]{"|-1|Tao hơn hẳn mày, mày nên cầu cho may mắn ở phía mày đi",
                ...
                "|-1|Ta sẽ tàn sát khu này trong vòng 5 phút nữa",
                "|-1|Hahaha mày đây rồi",
                "|-1|Tao đã có lệnh từ đại ca Picolo rồi"
            }, //text chat 2
            new String[]{"|-2|Đẹp trai nó phải thế"}, //text chat 3
            REST_30_M //second rest
    );

    public static final BossData PICOLOSAMA = new BossData(
            "Picolo Sama", //name
            ConstPlayer.NAMEC, //gender
            new short[]{1865, 1866, 1867, 192, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            345000, //dame
            new long[]{2000000000L}, //hp
            new int[]{231}, //map join
            new int[][]{
                ...
                //{Skill.DE_TRUNG, 7, 15000},
                {Skill.LIEN_HOAN, 7, 10000}},//skill,//skill //skill
            new String[]{"|-1|Tao là Super Namec",
                "|-2|Em chào đại ca!",
    ...
    public static final BossData CADIC = new BossData(
            "Cadic Majinbu", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1916, 1914, 1915, 200, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            145000, //dame
            new long[]{500000000L}, //hp
            new int[]{226, 227}, //map join
            new int[][]{
                {Skill.ANTOMIC, 1, 13}, {Skill.ANTOMIC, 2, 14}, {Skill.ANTOMIC, 3, 15}, {Skill.ANTOMIC, 4, 16}, {Skill.ANTOMIC, 5, 17}, {Skill.ANTOMIC, 6, 19}, {Skill.ANTOMIC, 7, 20},
                {Skill.MASENKO, 1, 21}, {Skill.MASENKO, 5, 22}, {Skill.MASENKO, 6, 23},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 10000},
                {Skill.BIEN_KHI, 1, 150000},
                {Skill.LIEN_HOAN, 7, 10000}},//skill
    ...
    public static final BossData CADICSSJ = new BossData(
            "Cadic SSJ 2", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1901, 1903, 1915, 209, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            145000, //dame
    ...
    public static final BossData ANDROID_15 = new BossData(
            ...
            new int[][]{
                {Skill.KAMEJOKO, 7, 100},
                {Skill.LIEN_HOAN, 7, 100},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{}, //text chat 2
    ...
    public static final BossData BASIL = new BossData(
            "Sói Basil", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{745, 746, 747, 118, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            300000, //dame
            new long[]{2000000000L}, //hp
            new int[]{230, 225}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO, FULL_DEMON, FULL_DRAGON, FULL_ANTOMIC, FULL_MASENKO), //skill
            new String[]{}, //text chat 1
    ...
    public static final BossData LAVENDER = new BossData(
            "Sói Lavender", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{748, 749, 750, 119, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            400000, //dame
            new long[]{2000000000L}, //hp
            new int[]{230, 225}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO, FULL_DEMON, FULL_DRAGON, FULL_ANTOMIC, FULL_MASENKO), //skill
            ...
            new String[]{"|-1|Ngươi thực sự rất mạnh dù không phải là một rôbốt. Ngươi không phải là Piccôlô",
                ...
                "|1|Hắn thực sự rất mạnh, đúng là cuộc chiến cân sức",}, //text chat 2
            new String[]{"|1| tiêu rồi, tớ lên trước nhé!",
    ...
    public static final BossData BERGAMO = new BossData(
            "Sói Bergamo", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{751, 752, 753, 120, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            500000, //dame
            new long[]{2000000000L}, //hp
            new int[]{230, 225}, //map join
            (int[][]) Util.addArray(FULL_GALICK, FULL_KAMEJOKO, FULL_DEMON, FULL_DRAGON, FULL_ANTOMIC, FULL_MASENKO), //skill
...
//**************************************************************************
    ...
    public static final BossData XEN_BO_HUNG_2 = new BossData(
            ...
            new String[]{"|-2|Cái gì kia vậy!? Đó là loài gì thế!!?",
                ...
                "|-1|Sao vậy, Picôlô? Nếu ngươi muốn ngăn ta lại thì xong lên đi chứ!?"}, //text chat 1
    ...
    public static final BossData CUMBER = new BossData(
            "Broly Tà Ác", //name
            ConstPlayer.XAYDA, //gender
            new short[]{2000, 2001, 2002, 183, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            500000, //dame
            new long[]{2100000000L}, //hp
            new int[]{236}, //map join
            new int[][]{
                {Skill.ANTOMIC, 1, 13}, {Skill.ANTOMIC, 2, 14}, {Skill.ANTOMIC, 3, 15}, {Skill.ANTOMIC, 4, 16}, {Skill.ANTOMIC, 5, 17}, {Skill.ANTOMIC, 6, 19}, {Skill.ANTOMIC, 7, 20},
                {Skill.MASENKO, 1, 21}, {Skill.MASENKO, 5, 22}, {Skill.MASENKO, 6, 23},
                {Skill.DICH_CHUYEN_TUC_THOI, 3, 100000},
                {Skill.THAI_DUONG_HA_SAN, 1, 150000},
                {Skill.LIEN_HOAN, 7, 10000},//skill
                {Skill.BIEN_KHI, 1, 100000}}, //skill
    ...
    public static final BossData SONGOKU_TA_AC = new BossData(
            ...
            ConstPlayer.XAYDA, //gender
            new short[]{1303, 1304, 1305, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            200000,
            //dame
            new long[]{2100000000L}, //hp
    ...
    public static final BossData BROLY = new BossData(
            "Broly", //name
            ConstPlayer.XAYDA, //gender
            new short[]{1947, 1950, 1951, 203, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            Util.nextInt(1000, 5000), //dame
            new long[]{Util.nextInt(10000, 1000000)}, //hp
            new int[]{6, 27, 28, 29, 30, 13, 31, 32, 33, 34, 10, 19, 20, 35, 36, 37, 38}, //map join
    ...
    public static final BossData SUPER_XEN = new BossData(
            "Fu Tương Lai", //name
            ConstPlayer.TRAI_DAT, //gender
            new short[]{1765, 1766, 1767, -1, -1, -1}, //outfit {head, body, leg, bag, aura, eff}
            25000, //dame
            new long[]{2000000000L}, //hp
            new int[]{235}, //map join
            new int[][]{
                {Skill.LIEN_HOAN, 1, 300}, {Skill.LIEN_HOAN, 2, 400}, {Skill.LIEN_HOAN, 3, 500}, {Skill.LIEN_HOAN, 4, 600}, {Skill.LIEN_HOAN, 5, 700}, {Skill.LIEN_HOAN, 6, 800}, {Skill.LIEN_HOAN, 7, 900},
                {Skill.KAMEJOKO, 7, 600}, {Skill.KAMEJOKO, 6, 700}, {Skill.KAMEJOKO, 5, 800}, {Skill.KAMEJOKO, 4, 900}, {Skill.KAMEJOKO, 3, 1000}, {Skill.KAMEJOKO, 2, 1100}, {Skill.KAMEJOKO, 1, 1002},
                {Skill.ANTOMIC, 1, 130}, {Skill.ANTOMIC, 2, 140}, {Skill.ANTOMIC, 3, 150}, {Skill.ANTOMIC, 4, 160}, {Skill.ANTOMIC, 5, 170}, {Skill.ANTOMIC, 6, 190}, {Skill.ANTOMIC, 7, 200},
...
//---------------------BOSS MAI SU  PILAF -------------------------------    
    ...
    public static final BossData SU = new BossData(
            ...
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat 1
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat 2
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat
            REST_5_M
    );
    ...
    public static final BossData PI_LAP = new BossData(
            ...
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat 1
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat 2
            new String[]{"|-1|AS NRO IS NUMBER ONE"}, //text chat 3
            REST_5_M
    );
    public static final BossData KAMIRIN = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 1, 50000},},//skill//skill
            new String[]{"|-1|Sôn..gôku",
                "|-2|Lại là Androi à.. rốt cuộc ông ta đã tạo ra bao nhiêu Anhrin nhân tạo thế nhỉ?",
                "|-1|Bọn ta là rôbốt sát thủ, sinh ra từ máy tính ngài Androi,..",
                "|-1|..cho một mục tiêu duy nhất là giết Sôngôku!",
                "|-2|Máy tính? Để giết Gôku sao?",
                "|-1|Mong muốn trả thù Gôku của ngài Androi đã được lưu hết vào máy tính..",
                "|-1|.., Bọn ta sinh ra từ lòng căm thù ngày một tăng bên trong chiếc máy tính có chứa mong muốn trả thù",
                "|-1|Mục tiêu của bọn ta chỉ là Gôku, nhưng mà.. nếu ngươi mà cản đường thì là chuyện khác!",}, //text chat 1
            new String[]{"|-1|Sao thế hả? Ta mới chỉ khởi động thôi mà!",
                "|-2|Ngươi đánh giá thấp bọn ta quá đấy!",
    ...
    public static final BossData KAMILOC = new BossData(
            ...
            new String[]{}, //text chat 2
            new String[]{"|0| Androi  tiêu tùng cả rồi à?"}, //text chat 3
            REST_30_M
    );
    public static final BossData BOSS_MA_VUONG_PICOLO = new BossData(
            ...
            new String[]{"|-2|Đã đến thời gian chỉ định Tái tạo, tái tạo nào..."}, // text chat 1
    ...
    public static final BossData BOSS_BANG_TINH = new BossData(
            ...
            100000,
            new long[]{5000000000L},
            new int[]{31, 32, 33, 34, 10, 19, 20, 35, 36, 37, 38},
            new int[][]{
                {Skill.KAMEJOKO, 7, 1000},
    ...
    public static final BossData BOSS_MA_BU_COM = new BossData(
            ...
            new int[][]{
                ...
                {Skill.KHIEN_NANG_LUONG, 1, 18000},
                {Skill.LIEN_HOAN, 7, 500},
    ...
    public static final BossData BOSS_MA_BU_DEP_TRAI = new BossData(
            ...
            1000000,
            new long[]{3_500_000_000L},
            new int[]{105, 106, 107, 108, 109, 110},
            new int[][]{
                {Skill.KAMEJOKO, 7, 500},
                {Skill.KHIEN_NANG_LUONG, 1, 18000},
                {Skill.LIEN_HOAN, 7, 500},
                {Skill.THAI_DUONG_HA_SAN, 2, 40000},
                {Skill.TAI_TAO_NANG_LUONG, 1, 120000},
                {Skill.THOI_MIEN, 7, 30000}
            },
            new String[]{"|-2|Tái tạo, tái tạo nào..."}, // text chat 1
    ...
    public static final BossData BOSS_KHI_ULTRA = new BossData(
            ...
            new String[]{"|-1|19h đến 23h rồi, ta sẽ cho ngươi thấy sức mạnh của ta"}, // text chat 2
