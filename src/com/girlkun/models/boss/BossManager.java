...
import com.girlkun.models.boss.list_boss.nappa.baconsoi;
...
import com.girlkun.models.boss.list_boss.Picolo.picolo;
import com.girlkun.models.boss.list_boss.Picolo.babymonkey;
import com.girlkun.models.boss.list_boss.Picolo.shenron;
import com.girlkun.models.boss.list_boss.Picolo.blackgoku;
import com.girlkun.models.boss.list_boss.Picolo.zamas1;
...
public class BossManager implements Runnable {
    ...
    public void loadBoss() {
        ...
        try {
            ...
            this.createBoss(BossID.MAI);
            this.createBoss(BossID.PI_LAP);
            this.createBoss(BossID.CADIC1);
            this.createBoss(BossID.CADIC1);
            this.createBoss(BossID.CADIC2);
            this.createBoss(BossID.CADIC2);
            this.createBoss(BossID.CADICTL);
...
//             this.createBoss(BossID.BOSS_THO_DAI_KA);
    ...
    public Boss createBossDoanhTrai(int bossID, int dame, int hp, Zone zone) {
        System.out.println("create boss doanh trai");
        try {
            switch (bossID) {
...
//            }
    ...
    public void showListBossClient(Player player) {
//        if (!player.isAdmin() && !player.isAdmin()) {
//            return;
//        }
        Message msg;
