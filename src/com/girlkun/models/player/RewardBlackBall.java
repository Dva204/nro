...
public class RewardBlackBall {
    ...
    private void getReward(int star) {
        if (timeOutOfDateReward[star - 1] > System.currentTimeMillis()
            ...
            switch (star) {
    case 1:
        player.nPoint.dame += (player.nPoint.dame * 20 / 100); // +21% sức đánh
        break;
    case 2:
        player.nPoint.hpMax += (player.nPoint.hpMax * 30 / 100); // +33% HP
        break;
    case 3:
        player.nPoint.tlHutHp = 10; // Biến 10% tấn công thành HP
        break;
    case 4:
        player.nPoint.tlPST = 25; // Phản 25% sát thương
        break;
    case 5:
        player.nPoint.tlDameCrit.add(21); // 21% sức đánh chí mạng
     break;
    case 6:
        player.nPoint.mpMax += (player.nPoint.mpMax * 33 / 100); // +33% KI
        break;
    case 7:
        player.nPoint.tlNeDon = 15; // +15% né đòn
        break;
            }
