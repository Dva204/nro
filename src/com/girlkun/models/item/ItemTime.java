    ...
    public void update() {
        if (isCauCa) {
            if (Util.canDoWithTime(lastTimeCauCa, 10000)) {
                isCauCa = false;
                int[] listCa1 = new int[] { 1416, 1415, 1406, 2000 + player.gender, 14, 1416, 1415, 1406, 1398, 1397, };
                //cá heo xanh, cá chép vây đỏ, Rương kho báu, Rương đồ KH, nr, kit sửa cần câu, kit nâng cấp cần câu
                
                
                
                int[] listCa2 = new int[] { 1407, 1409, 1417, 1412, 1078, 1084, 1085, 1086, 1407, 1409, 1417, 1412, 15,
                        1358, 1359, 1360, 1361, };
                //cua hoàng đế, Rùa, rương vàng,hàu, ct gotexk pixel, mvbt2, mvbtc3, mvbtc4
