            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|2| Ta sẽ bán đồ Hủy diệt cho ngươi",
                                "Cửa hàng\nHủy diệt",
                                "Đóng");
                    }
                }
                                ...
                                if (player.check99ThucAnHuyDiet()) {
                                    if (player.setClothes.setGod() == 5) {
                                        ...
                                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                                "Yêu cầu mặc đủ 5 món Thần linh", "Đóng");
                                    }
                                } else {
                                    createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                            "Ngươi chưa đủ 99 thức ăn", "Đóng");
                                }
                                break;
                            }
                            break;
...
//                                    break;
                        ...
                        switch (ConstEvent.EVENT) {
                            ...
                            case 4:
                                this.createOtherMenu(player, ConstEvent.HLWEEN,
                                        "Sự kiện Halloween chính thức tại Ngọc Rồng As\n"
                            ...
                            case 5:
                                this.createOtherMenu(player, ConstEvent.NHAGIAO,
                                        "Sự kiện 20/11 chính thức tại Ngọc Rồng As\n"
                            ...
                            case 6:
                                this.createOtherMenu(player, ConstEvent.NOEL,
                                        "Sự kiên giáng sinh Ngọc Rồng As"
                            ...
                            case 7:
                                this.createOtherMenu(player, ConstEvent.TET,
                                        "Mừng Ngày Tết Nguyên Đán Ngọc Rồng As"
                            ...
                            case 8:
                                this.createOtherMenu(player, ConstEvent.PHUNU,
                                        "Sự kiện 8/3 chính thức tại Ngọc Rồng As"
                                    ...
                                    case 0:
                                        ...
                                        if (SaoBien == null || SaoBien.quantity < 999) {
                                            ...
                                            if (Util.isTrue(99, 100)) {
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, ngocrong);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được " + ngocrong.template.name);
                                            } else if (Util.isTrue(1, 100)) {
                                                Item ngocrong2 = ItemService.gI().createNewItem((short) Util.nextInt(14, 15));
                                                InventoryServiceNew.gI().addItemBag(player, ngocrong2);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được " + ngocrong2.template.name);
                                            }
                                        }
                                        break;
                                    case 1:
                                    ...
                                    case 0:
                                        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                            ...
                                            if (keo != null && banh != null && bingo != null) {
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, GioBingo, 0);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.getInstance().sendThongBao(player, "Đổi quà sự kiện thành công");
                                            } else {
                                                Service.getInstance().sendThongBao(player,
                                                        "Vui lòng chuẩn bị x10 Nguyên Liệu Kẹo Bàn Tay, Bánh Quy, Bí Ngô để đổi vật phẩm sự kiện");
                                            }
                                        } else {
                                    ...
                                    case 1:
                                        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                            ...
                                            if (ve != null && giokeo != null) {
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, Hopmaquy, 0);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.getInstance().sendThongBao(player, "Đổi quà sự kiện thành công");
                                            } else {
                                                Service.getInstance().sendThongBao(player,
                                                        "Vui lòng chuẩn bị x3 Vé đổi Kẹo và x3 Giỏ Thức Ăn để đổi vật phẩm sự kiện");
                                            }
                                        } else {
                                            Service.getInstance().sendThongBao(player, "Hành trang đầy.");
                                        }
                                    ...
                                    case 2:
                                        if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                            ...
                                            if (ve != null && giokeo != null && hopmaquy != null) {
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, HopQuaHLW, 0);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.getInstance().sendThongBao(player,
                                                        "Đổi quà hộp quà sự kiện Halloween thành công");
                                            } else {
                                                Service.getInstance().sendThongBao(player,
                                                        "Vui lòng chuẩn bị x3 Hộp Quà Basic, x3 Vé đổi Kẹo và x3 Giỏ Thức Ăn để đổi vật phẩm sự kiện");
                                            }
                                        } else {
                                            Service.getInstance().sendThongBao(player, "Hành trang đầy.");
                                        }
                            ...
                            case ConstEvent.NOEL:
                                if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                    ...
                                    if (keogiangsinh != null && keogiangsinh.quantity >= 99) {
                                        ...
                                        InventoryServiceNew.gI().addItemBag(player, tatgiangsinh, 0);
                                        InventoryServiceNew.gI().sendItemBags(player);
    ...
    public static Npc Pic2Mai(int mapId, int status, int cx, int cy, int tempId, int avartar) { // sự kiện hè
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            @Override
            public void openBaseMenu(Player player) {
                if (this.mapId == 7) {
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            case 0:
                                ...
                                break;
                            case 1:
                                if (ConstEvent.EVENT == ConstEvent.HUNGVUONG) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        if (player.iDMark.getIndexMenu() == 1234) {
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 573) == null) {
                                    ...
                                    try {
                                        ...
                                        while (timex1 > 0) {
                                            timex1--;
                                            count++;
                                            InventoryServiceNew.gI().subQuantityItemsBag(player, InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 573), 2);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            Thread.sleep(100);
                                            if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 573) == null) {
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 574) == null) {
                                    ...
                                    try {
                                        ...
                                        while (timex1 > 0) {
                                            timex1--;
                                            count++;
                                            InventoryServiceNew.gI().subQuantityItemsBag(player, InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 574), 2);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            Thread.sleep(100);
                                            if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 574) == null) {
                                                this.createOtherMenu(player, 12346, "|7|HẾT XU!\nSỐ LƯỢT ĐÃ QUAY : " + count,
                                            ...
                                            if (InventoryServiceNew.gI().getCountEmptyBag(player) > 0) {
                                                if (Util.isTrue(10, 100)) {
                                                    InventoryServiceNew.gI().addItemBag(player, gapx1);
                                                    this.createOtherMenu(player, 12346, "|7|ĐANG TIẾN HÀNH QUAY AUTO X1\nSỐ LƯỢT CÒN : " + timex1 + " LƯỢT\n" + "|2|Đã gắp được : " + gapx1.template.name + "\nSố xu còn : " + InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 574).quantity + "\n|7|TỔNG ĐIỂM : " + player.point_gapthu + "\nNẾU HÀNH TRANG ĐẦY, ITEM SẼ ĐƯỢC THÊM VÀO RƯƠNG PHỤ",
                                                            "Quay X1", "Quay X10", "Quay X100", "Rương Đồ");
                                                } else {
                                                    this.createOtherMenu(player, 12346, "|7|ĐANG TIẾN HÀNH QUAY AUTO X1\nSỐ LƯỢT CÒN : " + timex1 + " LƯỢT\n" + "|2|Quay hụt rồi!" + "\nSố xu còn : " + InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 574).quantity + "\n|7|TỔNG ĐIỂM : " + player.point_gapthu + "\nNẾU HÀNH TRANG ĐẦY, ITEM SẼ ĐƯỢC THÊM VÀO RƯƠNG PHỤ",
                                                            "Quay X1", "Quay X10", "Quay X100", "Rương Đồ");
                            ...
                            switch (select) {
                                case 0:
                                    if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 2007) == null) {
                                    ...
                                    try {
                                        ...
                                        while (timex1 > 0) {
                                            timex1--;
                                            count++;
                                            InventoryServiceNew.gI().subQuantityItemsBag(player, InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 2007), 2);
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            Thread.sleep(100);
                                            if (InventoryServiceNew.gI().findItem(player.inventory.itemsBag, 2007) == null) {
                                                this.createOtherMenu(player, 12347, "|7|HẾT XU!\nSỐ LƯỢT ĐÃ QUAY : " + count,
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 2221, "|7|Ở dây ta có bán CS thường\n"
                                            + "|5|Ta hỗ trợ mua với số lượng lớn quy định như sau:\n"
                                            + "|5|15 CS thường = 10 Thỏi vàng\n"
                                            + "|5|150 CS thường = 105 Thỏi vàng\n"
                                            + "|5|1600 CS thường = 1100 Thỏi vàng\n"
                                            + "|3|Ngươi muốn mua số lượng bao nhiêu?", ""
                                            + "Mua 15 CS", "Mua 150 CS", "Mua 1600 CS");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, 2222, "|7|Ở dây ta có bán CS cao cấp\n"
                                            + "|1|Giá Nước hoa tại Cửa hàng Santa: 500Tr vàng\n"
                                            + "|5|Ta hỗ trợ mua với số lượng lớn quy định như sau:\n"
                                            + "|5|13 CS cao cấp = 10 Thỏi vàng\n"
                                            + "|5|135 CS cao cấp = 105 Thỏi vàng\n"
                                            + "|5|1500 CS cao cấp = 1100 Thỏi vàng\n"
                                            + "|3|Ngươi muốn mua số lượng bao nhiêu?", ""
                                            + "Mua 13 CS", "Mua 135 CS", "Mua 1400 CS");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, 2223, "|7|Ở dây ta có bán XU Vip\n"
                                            ...
                                            + "|5|105 Xu vip = 120 Thỏi vàng\n"
                                            + "|5|1100 Xu vip = 1200 Thỏi vàng\n"
                                            + "|3|Ngươi muốn mua số lượng bao nhiêu?", ""
                                            + "Mua 10 CS", "Mua 105 CS", "Mua 1110 CS");
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 10) {
                                        ...
                                        Item capsule = ItemService.gI().createNewItem((short) 573, 15);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 10;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 15 CS");
                                    }
                                    break;
                                case 1:
                                    Item tv1 = null;
                                    ...
                                    if (tv1 == null || tv1.quantity < 150) {
                                        this.npcChat(player, "Con còn thiếu x150 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv1, 150);
                                        Item capsule = ItemService.gI().createNewItem((short) 573, 105);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        //player.point_gapthu += 100;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 105 CS");
                                    }
                                    break;
                                case 2:
                                    Item tv2 = null;
                                    ...
                                    if (tv2 == null || tv2.quantity < 1100) {
                                        this.npcChat(player, "Con còn thiếu x1100 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 1100);
                                        Item capsule = ItemService.gI().createNewItem((short) 573, 1600);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 1000;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 1600 CS");
                                    }
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == 2222) {
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 10) {
                                        ...
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv, 10);
                                        Item capsule = ItemService.gI().createNewItem((short) 574, 13);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 10;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 13 CS");
                                    }
                                    break;
                                case 1:
                                    Item tv1 = null;
                                    ...
                                    if (tv1 == null || tv1.quantity < 105) {
                                        this.npcChat(player, "Con còn thiếu x105 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv1, 105);
                                        Item capsule = ItemService.gI().createNewItem((short) 574, 135);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 100;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 135 CS");
                                    }
                                    break;
                                case 2:
                                    Item tv2 = null;
                                    ...
                                    if (tv2 == null || tv2.quantity < 1500) {
                                        this.npcChat(player, "Con còn thiếu x1500 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 1500);
                                        Item capsule = ItemService.gI().createNewItem((short) 574, 1100);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 1000;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 1100 CS");
                                    }
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (tv == null || tv.quantity < 10) {
                                        ...
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv, 10);
                                        Item capsule = ItemService.gI().createNewItem((short) 2007, 10);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        //  player.point_gapthu += 10;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 10 CS");
                                    }
                                    break;
                                case 1:
                                    Item tv1 = null;
                                    ...
                                    if (tv1 == null || tv1.quantity < 120) {
                                        this.npcChat(player, "Con còn thiếu x120 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv1, 120);
                                        Item capsule = ItemService.gI().createNewItem((short) 2007, 105);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 100;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 105 CS");
                                ...
                                case 2:
                                    ...
                                    if (tv2 == null || tv2.quantity < 1200) {
                                        this.npcChat(player, "Con còn thiếu x1200 thỏi vàng");

                                    } else if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
                                        this.npcChat(player, "Hành trang của bạn không đủ chỗ trống");
                                    } else {
                                        InventoryServiceNew.gI().subQuantityItemsBag(player, tv2, 1200);
                                        Item capsule = ItemService.gI().createNewItem((short) 2007, 1100);
                                        InventoryServiceNew.gI().addItemBag(player, capsule);
                                        // player.point_gapthu += 1000;
                                        InventoryServiceNew.gI().sendItemBags(player);
                                        this.npcChat(player, "Con nhận được 1100 CS");
                    ...
                    switch (select) {
                        ...
                        case 1:
                            if (pl.nPoint.power < 17000000000L) {
                                Service.gI().sendThongBao(pl, "Vui lòng đạt 17 tỷ sức mạnh và đạt nhiệm vụ 30");
                ...
                if (canOpenNpc(player)) {
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        ...
                        if (player.getSession().is_gift_box) {
                            ...
                            int soMon = (player.getSession().itemsReward == null) ? 0
                                    : player.getSession().itemsReward.size();
                            this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chào con, con muốn ta giúp gì nào?",
                                    "Nhiệm\nVụ", "Nói chuyện",
                                    "Nhận phần\nthưởng (" + soMon + ")");  // hiển thị số món
                        }
                    }
                }
            }
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2: // Nhận phần thưởng ← THÊM MỚI
                                if (player.getSession().itemsReward == null
                                        || player.getSession().itemsReward.isEmpty()) {
                                    this.createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                            "Con không có phần thưởng nào đang chờ.", "Đóng");
                                } else {
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    if (player.getSession().actived) {
                        mtv = "Bạn đã là thành viên chính thức của Ngọc Rồng As. Đã mở khóa tính năng Giao dịch và Chat thế giới !!!";
                    } else {
                    ...
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|7| ～♪ CHÀO MỪNG BẠN ĐÃ ĐẾN VỚI NGỌC RỒNG AS ♪⁠～  \n"
                                //+ "|2| Sever By Obito\n"
                                + "|2| Zalo Admin : 0876818840\n"
                                ...
                                "Hỗ Trợ", "Mở Thành Viên 10K", "Điểm danh", "Nhập mã quà tặng", "Khu test dame", "Nhận \nHồng Ngọc", "Nhận \nThỏi Vàng");
                        ...
                        switch (select) {
                            case 0:
                                createOtherMenu(player, ConstNpc.HOTRO,
                                        "|7|HỖ TRỢ PLAYER\n"
                                        + "|2| 1. Nhận Ngọc Xanh  -  Free : 500.000 Ngọc Xanh\n"
                                        + "|2| 2. Next Nhiệm Vụ Thần Mèo, Tàu77, Bang hội",
                                        "Nhận\nNgọc\nXanh", "Next\nNhiệm\nVụ");
                                break;
                            case 1:
                                if (player.getSession().actived) {
...
//                                        && player.playerTask.taskMain.id >= 21 && !player.getSession().actived) {
//                                    player.getSession().actived = true;
//                                    PlayerDAO.setActive(player, true); // ← Ghi vào DB để giữ vĩnh viễn
//                                    Service.gI().sendThongBao(player, "Bạn đã hoàn thành nhiệm vụ 21 và được mở thành viên miễn phí");
//                                    break;
//                                }
                                if (player.getSession().vnd >= 10000) {
                                    if (PlayerDAO.subvnd(player, 10000)) {
                                        player.getSession().actived = true;
                                        PlayerDAO.setActive(player, true);
                                        ...
                                        if (thoivang == null) {
                                            ...
                                            InventoryServiceNew.gI().sendItemBags(player);
                                            //  Service.gI().sendThongBao(player, "Bạn đã mở thành viên thành công và nhận được 20 thỏi vàng");
                            ...
                            case 2:
                                if (!player.getSession().actived) {
                                    ...
                                    this.npcChat(player, "Chức năng này đang bảo trì !");
...
//                                break;
                        ...
                        switch (select) {
                            case 0:
                                if (player.inventory.gem >= 500000) {
                            ...
                            case 1:
                                if (player.playerTask.taskMain.id == 5) {
                                    if (player.playerTask.taskMain.index == 5) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_5_5);
                                    } else {
                                    ...
                                    if (player.playerTask.taskMain.index == 6) {
                                        TaskService.gI().doneTask(player, ConstTask.TASK_5_6);
                                    } else {
                                        Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    }
                                    ...
                                    // } else if (player.playerTask.taskMain.id == 30) {
                                    //     if (player.playerTask.taskMain.index == 0) {
                                    //          TaskService.gI().doneTask(player, ConstTask.TASK_30_0);
                                    ...
                                    //             TaskService.gI().doneTask(player, ConstTask.TASK_30_1);
                                    //         }
                                    //     } else if (player.playerTask.taskMain.index == 2) {
                                    //         for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                    //             TaskService.gI().doneTask(player, ConstTask.TASK_30_2);
                                    //         }
                                    //     } else if (player.playerTask.taskMain.index == 3) {
                                    //         for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                    //             TaskService.gI().doneTask(player, ConstTask.TASK_30_3);
                                    //         }
                                    //     } else if (player.playerTask.taskMain.index == 4) {
                                    //         for (int i = player.playerTask.taskMain.subTasks.get(player.playerTask.taskMain.index).count; i < 25; i++) {
                                    //             TaskService.gI().doneTask(player, ConstTask.TASK_30_4);
                                    //        }    
                                    //    } else {
                                    //         Service.getInstance().sendThongBao(player, "Ta đã giúp con hoàn thành nhiệm vụ rồi mau đi trả nhiệm vụ");
                                    //    }
                        ...
                        switch (select) {
                            ...
                            case 2:
                                if (player.getSession().actived && player.cFlag == 10 && vodaiBallNumber >= 7) {
                                    int[] itemDos = new int[]{457, 1669};
                                    for (int itemId : itemDos) {
                                        Item item = ItemService.gI().createNewItem((short) itemId);
                                        item.quantity = 10; // Đặt số lượng là 10 cho mỗi vật phẩm
            ...
            public void openBaseMenu(Player pl) {
                if (canOpenNpc(pl)) {
                    if (this.mapId == 84) {
                        ...
                        if (pl.playerTask.taskMain.id == 3) {
                            //TaskService.gI().doneTask(pl, ConstTask.TASK_7_0); 
                            NpcService.gI().createTutorial(pl, this.avartar, "Hãy lên đường cứu đứa bé nhà tôi\n"
                                    + "Chắc bây giờ nó đang sợ hãi lắm rồi");
                        } else {
                            this.createOtherMenu(pl, ConstNpc.BASE_MENU,
                                    "Tàu Vũ Trụ của ta có thể đưa cậu đến hành tinh khác chỉ trong 3 giây. Cậu muốn đi đâu?",
                                    "Đến\nNamếc", "Đến\nXayda", "Siêu thị", "Trạm tàu \nVampa", "Trạm tàu \nPlant");
                        }
                    }
                }
            }
                    ...
                    if (this.mapId == 84) {
                        ...
                        switch (select) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                if (player.getSession().player.nPoint.power >= 200000000000L
                                        && player.playerTask.taskMain.id >= 32) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 245, -1, -1);
                                } else {
                                    Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ 32 Và Đạt 200 Tỷ Sức Mạnh");
                                }
                                break;
                            case 4:
                                if (player.getSession().player.nPoint.power >= 200000000000L
                                        && player.playerTask.taskMain.id >= 32) {
                                    ChangeMapService.gI().changeMapBySpaceShip(player, 244, -1, -1);
                                } else {
                                    Service.gI().sendThongBaoOK(player, "Làm Nhiệm Vụ 32 Và Đạt 200 Tỷ Sức Mạnh");
                                }
                                break;
                    ...
                    if (this.mapId == 19) {
                                    ...
                                    switch (select) {
                                        case 0: // Kuku
                                            this.createOtherMenu(player, ConstNpc.MENU_FIND_KUKU,
                                                    "Ngươi muốn tìm Kuku?",
                                                    "Đến ngay\n(" + Util.numberToMoney(COST_FIND_BOSS) + " vàng)", "Từ chối");
                                            break;
                                        case 1: // Cold
                        ...
                        if (select == 0) {
                            ...
                            if (boss == null || boss.isDie()) {
                                ...
                                Service.gI().sendThongBao(player, "Không thể xác định vị trí boss.");
                            } else if (player.inventory.gold < COST_FIND_BOSS) {
...
//    public static Npc quydoi(int mapId, int status, int cx, int cy, int tempId, int avartar) {
//        return new Npc(mapId, status, cx, cy, tempId, avartar) {
//            @Override
//            public void openBaseMenu(Player player) {
//                if (canOpenNpc(player)) {
    ...
    public static Npc napvip(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    createOtherMenu(player, ConstNpc.BASE_MENU,
                            "Hello các tình yêu nhé , Shop anh bán hàng cho các con nghiện ",
                            "Tạp Hóa", "Shop Vip", "Quy đổi\nVNĐ", "Mốc Nạp", "Rút", "Hoi SKILL");
                }
            }
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 0:
                                    ...
                                    break;
//                                case 1 : 
//                                    ShopServiceNew.gI().opendShop(player, "SHOP_VNRO", true);
//                                    break;
                                case 1: //tiệm hồng ngọc
                                    ShopServiceNew.gI().opendShop(player, "SHOP_SU_KIEN_HE", true);
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI, "|7|Ví của bạn còn : " + Util.format(player.getSession().vnd) + " VNĐ" + "\n"
                                            + "|1|Dân chơi thì đổi đi", "Quy đổi\nThỏi vàng", "Quy đổi\nHồng ngọc", "Quy đổi\nXu Bạc", "Quy đổi\nXu Vàng", "Quy đổi\nĐồng Tiền", "Quy đổi\nĐá Bảo Vệ");
                                    break;
                                //case 2:
                                ...
                                //    break;
                                case 3:
                                    this.createOtherMenu(player, ConstNpc.NAP_TIEN, "\b|7|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ\n"
                                            + "\b|1|Mốc nạp càng cao giá trị quà càng lớn!",
                                            //+ "\b|7|Bạn đã nạp tích lũy được: " + Util.format(player.tongtien) + " VND",
                                            "Mốc Nạp ", "Đóng");
                                    break;
                                case 4:
                                    this.createOtherMenu(player, ConstNpc.RUT_TIEN,
                                            "|1| Đổi VNĐ ở đây rồi lên trên web để rút nhé nhé !!!"
                                            + "\b|2|Người chơi chỉ GIAO DỊCH DUY NHẤT qua website asnro.com hoặc zalo 0876818840"
                                            + "\b|7|Yêu quý Admin DONATE qua STK"
                                            + "\b|2|Chủ tài khoản : DO VAN AN"
                                            + "\b|3|Ngân hàng TECHCOMBANK , STK: 25838625082004"
                                            + "\b|4|Nội dung chuyển khoản: TÊN TÀI KHOẢN HOẶC TÊN NHÂN VẬT "
                                            + "\b|4|- (Để admin còn đáp lễ) -"
                                            + "\n|7| Ví của bạn còn : " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "Rút bằng \nTiền", "Rút bằng \nThỏi vàng", "Đóng");
                                    break;
                                case 5:
                        ...
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.RUT_TIEN) {
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, ConstNpc.TIEN_TO_VND,
                                            "|1| Có tiền thì đổi đi?\n"
                                            ...
                                            + "\n|2| 300 Tiền = 53k VNĐ"
                                            + "\n|2| 500 Tiền = 110k VNĐ"
                                            + "\n|2| 1000 Tiền = 225k VNĐ",
                                            "50 Tiền", "100 Tiền",
                                            "200 Tiền", "300 Tiền",
                                            "500 Tiền", "1000 Tiền");
                                    break;
                                case 1:
                                    this.createOtherMenu(player, ConstNpc.TV_TO_VND,
                                            "|1| Có tiền thì đổi đi?\n"
                                            + "|7|Con đang có :" + Util.format(player.getSession().vnd) + " VNĐ\n"
                                            + "\b|2|Người chơi chỉ GIAO DỊCH DUY NHẤT qua website asnro.com hoặc zalo 0876818840"
                                            + "\b|7|Yêu quý Admin DONATE qua STK"
                                            ...
                                            + "\b|4|Nội dung chuyển khoản: TÊN TÀI KHOẢN HOẶC TÊN NHÂN VẬT "
                                            + "\b|4|- (Để admin còn đáp lễ) -\n"
                                            + "\n|2| 40 Thỏi vàng = 10k VNĐ"
                                            + "\n|2| 80 Thỏi vàng = 20k VNĐ"
                                            + "\n|2| 160 Thỏi vàng = 41k VNĐ"
                                            + "\n|2| 240 Thỏi vàng = 53k VNĐ"
                                            + "\n|2| 400 Thỏi vàng = 110k VNĐ"
                                            + "\n|2| 800 Thỏi vàng = 225k VNĐ",
                                            "40 Thỏi", "80 Thỏi",
                                            "160 Thỏi", "240 Thỏi",
                                            "400 Thỏi", "800 Thỏi");
                                    break;
                        ...
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.TIEN_TO_VND) {
                            switch (select) {
                                case 0:
                                    Item tien = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien.quantity < 50) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 50 Tiền");
                                        return;
                                    }
                                    try {
                                    ...
                                    tien.quantity -= 50;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 10k VNĐ");
                                    break;
                                case 1:
                                    Item tien1 = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien1.quantity < 100) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 100 Tiền");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 20000;
                                        PlayerDAO.addvnd(player, 20000);
                                        GirlkunDB.executeUpdate(
                                                "update account set vnd = ? where id = ?", sum,
                                                player.account_id);
                                        player.getSession().vnd = sum;
                                    ...
                                    tien1.quantity -= 100;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 20k VNĐ");
                                    break;
                                case 2:
                                    Item tien2 = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien2.quantity < 200) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 200 Tiền");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 41000;
                                        PlayerDAO.addvnd(player, 41000);
                                        GirlkunDB.executeUpdate(
                                                "update account set vnd = ? where id = ?", sum,
                                                player.account_id);
                                        player.getSession().vnd = sum;
                                    ...
                                    tien2.quantity -= 200;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 41k VNĐ");
                                    break;
                                case 3:
                                    Item tien3 = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien3.quantity < 300) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 300 Tiền");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 53000;
                                        PlayerDAO.addvnd(player, 53000);
                                        GirlkunDB.executeUpdate(
                                                "update account set vnd = ? where id = ?", sum,
                                                player.account_id);
                                        player.getSession().vnd = sum;
                                    ...
                                    tien3.quantity -= 300;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 53k VNĐ");
                                    break;
                                case 4:
                                    Item tien4 = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien4.quantity < 500) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 500 Tiền");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 110000;
                                        PlayerDAO.addvnd(player, 110000);
                                        GirlkunDB.executeUpdate(
                                                "update account set vnd = ? where id = ?", sum,
                                                player.account_id);
                                        player.getSession().vnd = sum;
                                    ...
                                    tien4.quantity -= 500;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 110k VNĐ");
                                    break;
                                case 5:
                                    Item tien5 = InventoryServiceNew.gI().findItemBag(player, 1861);
                                    if (tien5.quantity < 1000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 1000 Tiền");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 225000;
                                        PlayerDAO.addvnd(player, 225000);
                                        GirlkunDB.executeUpdate(
                                                "update account set vnd = ? where id = ?", sum,
                                                player.account_id);
                                        player.getSession().vnd = sum;
                                    ...
                                    tien5.quantity -= 1000;
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 225k VNĐ");
                                    break;
                            }
                        } else if (player.iDMark.getIndexMenu() == ConstNpc.TV_TO_VND) {
                            switch (select) {
                                case 0:
                                    Item tien = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien.quantity < 40) {
                                    ...
                                    break;
                                case 1:
                                    Item tien1 = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien1.quantity < 80) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 80 Thỏi vàng");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 20000;
                                    ...
                                    break;
                                case 2:
                                    Item tien2 = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien2.quantity < 160) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 160 Thỏi vàng");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 41000;
                                    ...
                                    break;
                                case 3:
                                    Item tien3 = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien3.quantity < 240) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 240 Thỏi vàng");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 53000;
                                    ...
                                    break;
                                case 4:
                                    Item tien4 = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien4.quantity < 400) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 400 Thỏi vàng");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 110000;
                                    ...
                                    break;
                                case 5:
                                    Item tien5 = InventoryServiceNew.gI().findItemBag(player, 457);
                                    if (tien5 == null || tien5.quantity < 800) {  // ADD null check here
                                        Service.gI().sendThongBao(player, "Bạn không đủ 800 Thỏi vàng");
                                        return;
                                    }
                                    try {
                                        int sum = player.getSession().vnd + 225000;
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_NGOC,
                                            "|1|Muốn đổi hồng ngọc à?\n"
                                            + "|7|Con đang có " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "20k\n30000 ngọc", "50k\n75000 ngọc", "100k\n150000 ngọc", "200k\n300000 ngọc");
                                    break;
                                case 2:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_XU_BAC,
                                            "|1|Muốn đổi tiền mặt à?\n"
                                            + "|7|Con đang có " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "20k\n25 Xu Bạc", "50k\n62 Xu Bạc", "100k\n130 Xu Bạc", "200k\n260 Xu Bạc");
                                    break;
                                case 3:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_XU_VANG,
                                            "|1|Muốn đổi tiền mặt à?\n"
                                            + "|7|Con đang có " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "20k\n20 Xu Vàng", "50k\n50 Xu Vàng", "100k\n105 Xu Vàng", "200k\n210 Xu Vàng");
                                    break;
                                case 4:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_TIEN,
                                            "|1|Muốn đổi tiền mặt à?\n"
                                            + "|7|Con đang có " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "20k\n24 Đồng", "50k\n60 Đồng", "100k\n120 Đồng", "200k\n240 Đồng");
                                    break;
                                case 5:
                                    this.createOtherMenu(player, ConstNpc.QUY_DOI_DBV,
                                            "|1|Muốn đổi tiền mặt à?\n"
                                            + "|7|Con đang có " + Util.format(player.getSession().vnd) + " VNĐ\n",
                                            "20k\n17 ĐBV", "100k\n90 ĐBV", "200k\n180 ĐBV");
                                    break;
                            ...
                            switch (select) {
                                case 0:
                                    ...
                                    if (item == null || !item.isNotNullItem() || item.quantity < 50) {
                                        Service.gI().sendThongBaoOK(player, "Không có đủ thỏi vàng!");
                                        return;
                                    }
                                    ...
                                    long now = System.currentTimeMillis();
                                    long lastTime = player.playerSkill.skillSelect.lastTimeUseThisSkill;
                                    int coolDown = player.playerSkill.skillSelect.coolDown;

                                    long timePassed = now - lastTime;
                                    long timeRemaining = coolDown - timePassed;

                                    // Nếu skill đã hồi xong
                                    if (timeRemaining <= 0) {
                                        Service.gI().sendThongBaoOK(player, "Skill đã hồi rồi!");
                                        return;
                                    }

                                    int subTimeParam = 99; // giảm 80%

                                    long reduceTime = timeRemaining * subTimeParam / 100;

                                    // giảm cooldown
                                    player.playerSkill.skillSelect.lastTimeUseThisSkill -= reduceTime;
                                    ...
                                    Service.gI().sendThongBao(player, "Đã giảm " + subTimeParam + "% thời gian hồi chiêu!");
                            ...
                            switch (select) {
                                ...
                                case 2:
                                    ...
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 105 thỏi vàng");
                                    break;
                                case 3:
                                    ...
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 210 thỏi vàng");
                                    break;
                                case 4:
                                    ...
                                    Item i5 = ItemService.gI().createNewItem((short) 457, (short) 525);
                                    InventoryServiceNew.gI().addItemBag(player, i5);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 525 thỏi vàng");
                                    break;
                                case 5:
                                    ...
                                    Item i6 = ItemService.gI().createNewItem((short) 457, (short) 1050);
                                    InventoryServiceNew.gI().addItemBag(player, i6);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 1050 thỏi vàng");
                                    break;
                            }
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    ...
                                    if (PlayerDAO.subquydoi(player, 50000)) {
                                        ...
                                        player.inventory.ruby += 75000;
                                        Service.getInstance().sendMoney(player);
                                        Service.gI().sendThongBao(player, "Bạn đã nhận được 75000 hồng ngọc");
                                    }
                                    break;
                                case 2:
                                    if (player.getSession().vnd < 100000) {
                                    ...
                                    if (PlayerDAO.subquydoi(player, 100000)) {
                                        ...
                                        Service.getInstance().sendMoney(player);
                                        Service.gI().sendThongBao(player, "Bạn đã nhận được 150000 hồng ngọc");
                                    }
                                    break;
                                case 3:
                                    if (player.getSession().vnd < 200000) {
                                    ...
                                    if (PlayerDAO.subquydoi(player, 200000)) {
                                        ...
                                        Service.getInstance().sendMoney(player);
                                        Service.gI().sendThongBao(player, "Bạn đã nhận được 300000 hồng ngọc");
                                    }
                            }

                        } else if (player.iDMark.getIndexMenu() == ConstNpc.QUY_DOI_XU_BAC) {
                            switch (select) {
                                case 0:
                                    if (player.getSession().vnd < 20000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 20k VND");
                                    ...
                                    Item i = ItemService.gI().createNewItem((short) 1394, (short) 25);
                                    InventoryServiceNew.gI().addItemBag(player, i);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 25 Xu Bạc");
                                    break;
                                case 1:
                                    if (player.getSession().vnd < 50000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 50k VND");
                                    ...
                                    Item i2 = ItemService.gI().createNewItem((short) 1394, (short) 62);
                                    InventoryServiceNew.gI().addItemBag(player, i2);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 62 Xu Bạc");
                                    break;
                                ...
                                case 2:
                                    ...
                                    Item i3 = ItemService.gI().createNewItem((short) 1394, (short) 130);
                                    InventoryServiceNew.gI().addItemBag(player, i3);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 130 Xu Bạc");
                                    break;
                                ...
                                case 3:
                                    ...
                                    Item i4 = ItemService.gI().createNewItem((short) 1394, (short) 260);
                                    InventoryServiceNew.gI().addItemBag(player, i4);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 260 Xu Bạc");
                                    break;

                            }

                        } else if (player.iDMark.getIndexMenu() == ConstNpc.QUY_DOI_XU_VANG) {
                            switch (select) {
                                case 0:
                                    if (player.getSession().vnd < 20000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 20k VND");
                                    ...
                                    Item i = ItemService.gI().createNewItem((short) 1395, (short) 20);
                                    InventoryServiceNew.gI().addItemBag(player, i);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 20 Xu Vàng");
                                    break;
                                case 1:
                                    if (player.getSession().vnd < 50000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 50k VND");
                                    ...
                                    Item i2 = ItemService.gI().createNewItem((short) 1395, (short) 50);
                                    InventoryServiceNew.gI().addItemBag(player, i2);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 50 Xu Vàng");
                                    break;
                                ...
                                case 2:
                                    ...
                                    Item i3 = ItemService.gI().createNewItem((short) 1395, (short) 105);
                                    InventoryServiceNew.gI().addItemBag(player, i3);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 105 Xu Vàng");
                                    break;
                                ...
                                case 3:
                                    ...
                                    Item i4 = ItemService.gI().createNewItem((short) 1395, (short) 210);
                                    InventoryServiceNew.gI().addItemBag(player, i4);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 210 Xu Vàng");
                                    break;

                            }

                        } else if (player.iDMark.getIndexMenu() == ConstNpc.QUY_DOI_TIEN) {
                            switch (select) {
                                case 0:
                                    if (player.getSession().vnd < 20000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 20k VND");
                                    ...
                                    Item i = ItemService.gI().createNewItem((short) 1861, (short) 24);
                                    InventoryServiceNew.gI().addItemBag(player, i);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 24 Đồng");
                                    break;
                                case 1:
                                    if (player.getSession().vnd < 50000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 50k VND");
                                    ...
                                    Item i2 = ItemService.gI().createNewItem((short) 1861, (short) 60);
                                    InventoryServiceNew.gI().addItemBag(player, i2);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 60 Đồng");
                                    break;
                                ...
                                case 2:
                                    ...
                                    Item i3 = ItemService.gI().createNewItem((short) 1861, (short) 120);
                                    InventoryServiceNew.gI().addItemBag(player, i3);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 120 Đồng");
                                    break;
                                ...
                                case 3:
                                    ...
                                    Item i4 = ItemService.gI().createNewItem((short) 1861, (short) 240);
                                    InventoryServiceNew.gI().addItemBag(player, i4);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 240 Đồng");
                                    break;

                            }

                        } else if (player.iDMark.getIndexMenu() == ConstNpc.QUY_DOI_DBV) {
                            switch (select) {
                                case 0:
                                    if (player.getSession().vnd < 20000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 20k VND");
                                    ...
                                    Item i = ItemService.gI().createNewItem((short) 987, (short) 17);
                                    InventoryServiceNew.gI().addItemBag(player, i);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 17 ĐBV");
                                    break;
                                ...
                                case 1:
                                    ...
                                    Item i2 = ItemService.gI().createNewItem((short) 987, (short) 90);
                                    InventoryServiceNew.gI().addItemBag(player, i2);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 90 ĐBV");
                                    break;
                                case 2:
                                    if (player.getSession().vnd < 200000) {
                                        Service.gI().sendThongBao(player, "Bạn không đủ 200k VND");
                                    ...
                                    Item i3 = ItemService.gI().createNewItem((short) 987, (short) 180);
                                    InventoryServiceNew.gI().addItemBag(player, i3);
                                    InventoryServiceNew.gI().sendItemBags(player);
                                    Service.gI().sendThongBao(player, "Bạn đã nhận được 180 ĐBV");
                                    break;
                            }
                            ...
                            switch (select) {
                                case 0: {
                                    try {
                                        GirlkunResultSet checkmocnap1 = GirlkunDB.executeQuery(
                                                "select * from account where id = ? and username = ?", player.getSession().userId, player.getSession().uu);
                                        if (checkmocnap1.next()) {
                                            int mnap = checkmocnap1.getInt("mocnap");
                                            this.createOtherMenu(player, 5,
                                                    ...
                                                    + "\b|2|Chủ tài khoản : DO VAN AN"
                                                    + "\b|3|Ngân hàng TECHCOMBANK , STK: 25838625082004"
                                                    + "\b|4|Nội dung chuyển khoản: TÊN TÀI KHOẢN HOẶC TÊN NHÂN VẬT - (Để admin còn đáp lễ)"
                                                    + "\b|4|Giao dịch qua tài khoản khác bị Scam Admin không chịu trách nhiệm"
                                                    + "\b|5|Hỗ trợ GDTG lưu động cho member có nhu cầu mua bán "
                                                    + "\b|6|LƯU Ý: HÃY MUA FULL Ô TRỐNG TRONG HÀNH TRANG ĐỂ TRÁNH NHẬN KO ĐỦ ĐỒ, NẾU MẤT ADMIN KO CHỊU TRÁCH NHIỆM!!!"
                                                    + "\b|7|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ"
                                                    + "\b|7|CHÚ Ý : NẾU NHẬN MỨC NẠP CAO HƠN SẼ \nKHÔNG THỂ NHẬN MỐC NẠP Ở DƯỚI NỮA !!!\n"
                                                    + "|5| Mốc nạp đã nhận : " + mnap,
                                                    "Nhận mốc 20k", "Nhận mốc 50k", "Nhận mốc 100k", "Nhận mốc 200k", "Nhận mốc 500k", "Nhận mốc 1200k", "Nhận mốc 2000k", "Nhận mốc 2500k", "Nhận mốc 3200k", "Nhận mốc 4000k");
                                        }
                                    } catch (Exception ex) {
                            ...
                            switch (select) {
                                case 0:
                                    this.createOtherMenu(player, 66,
                                            ...
                                            + "|7|x2000 Hồng ngọc\n"
                                            // + "|5|+ 20K VND\n"
                                            + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ\n"
                                ...
                                case 6:
                                    this.createOtherMenu(player, 122,
                                            ...
                                            + "|7|x7 Bộ ngọc rồng\n"
                                            + "|7|x150000 Hồng  Ngọc\n"
                                            + "|7|x1 Danh Hiệu Đại Gia 25% chỉ số\n"
                                            //+ "|5|+ 2000K VND\n"
                                            + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ\n"
                                            + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!",
                                            "Nhận ngay", "Từ chối");
                                ...
                                case 7:
                                    this.createOtherMenu(player, 123,
                                            ...
                                            + "|7|x10 Bộ ngọc rồng\n"
                                            + "|7|x200000 Hồng  Ngọc\n"
                                            + "|7|x1 Sách tuyệt kỹ 2 với 25% chỉ số\n"
                                            // + "|5|+ 2500K VND\n"
                                            + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ\n"
                                            + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!",
                                            "Nhận ngay", "Từ chối");
                                    break;
                                case 8:
                                    this.createOtherMenu(player, 124,
                                            "|6|Đây là quà mốc tích lũy!\n"
                                            + "|7|Mốc 3200K:\n"
                                            + "|7|x3000 Thỏi vàng\n"
                                            + "|7|x120 Đá ngũ sắc\n"
                                    ...
                                    break;
                                case 9:
                                    this.createOtherMenu(player, 125,
                                            "|6|Đây là quà mốc tích lũy!\n"
                                            + "|7|Mốc 4000K:\n"
                                            + "|7|x4000 Thỏi vàng\n"
                                            + "|7|x150 Đá ngũ sắc\n"
                                            ...
                                            + "|7|x20 Bộ ngọc rồng\n"
                                            + "|7|x350000 Hồng  Ngọc\n"
                                            + "|7|x1 Búa Mjolnir 30% chỉ số \n"
                                            + "|7|x1 Danh hiệu 'Kiếm Thế' 30% chỉ số \n"
                                            // + "|5|+ 4000K VND\n"
                                            + "|3|Bạn đã nạp tích lũy được: " + Util.format(player.getSession().tongnap) + " VNĐ\n"
                                            + "|2|Cảm ơn quý khách đã ghé, chúc bạn chơi game vui vẻ!",
                                            "Nhận ngay", "Từ chối");
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 20000 && mocnap < 20000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 20000, player.getSession().userId, player.getSession().uu);

                                                //Item i = ItemService.gI().createNewItem((short) 457, 20);
                                                Item i2 = ItemService.gI().createNewItem((short) 1394, 10);// xu bạc
                                                Item i3 = ItemService.gI().createNewItem((short) 457, 20);//thỏi vàng
                                                Item i4 = ItemService.gI().createNewItem((short) 861, 2000);
                                                //Item i5 = ItemService.gI().createNewItem((short) 674, 10);
                                                Item i6 = ItemService.gI().createNewItem((short) 573, 5);
                                                //  Item i6 = ItemService.gI().createNewItem((short) 2022, 1);

                                                //i6.itemOptions.add(new Item.ItemOption(50, 5));
                                                //  i6.itemOptions.add(new Item.ItemOption(77, 5));
                                                //  i6.itemOptions.add(new Item.ItemOption(103, 5));
                                                //  i6.itemOptions.add(new Item.ItemOption(14, 5));
                                                //  i6.itemOptions.add(new Item.ItemOption(5, 3));
                                                //InventoryServiceNew.gI().addItemBag(player, i);
                                                InventoryServiceNew.gI().addItemBag(player, i2);
                                                InventoryServiceNew.gI().addItemBag(player, i3);
                                                InventoryServiceNew.gI().addItemBag(player, i4);
                                                ...
                                                //InventoryServiceNew.gI().addItemBag(player, i6);
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 20k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                                    ...
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            ...
                                            if (player.getSession().tongnap >= 50000 && mocnap < 50000) {
                                                ...
                                                Item i = ItemService.gI().createNewItem((short) 457, 50);//tv
                                                // Item i2 = ItemService.gI().createNewItem((short) 674, 20);
                                                Item i3 = ItemService.gI().createNewItem((short) 1394, 25);//xu bạc
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 10);//tiền
                                                Item i5 = ItemService.gI().createNewItem((short) 573, 10);
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 5000);
                                                InventoryServiceNew.gI().addItemBag(player, i);
                                                //InventoryServiceNew.gI().addItemBag(player, i2);
                                                InventoryServiceNew.gI().addItemBag(player, i3);
                                                InventoryServiceNew.gI().addItemBag(player, i4);
                                    ...
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            ...
                                            if (player.getSession().tongnap >= 100000 && mocnap < 100000) {
                                                ...
                                                Item i = ItemService.gI().createNewItem((short) 457, 100);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 5);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 30);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 25);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 574, 20);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 10000);
                                                InventoryServiceNew.gI().addItemBag(player, i);
                                                InventoryServiceNew.gI().addItemBag(player, i2);
                                                InventoryServiceNew.gI().addItemBag(player, i3);
                                                InventoryServiceNew.gI().addItemBag(player, i4);
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 200000 && mocnap < 200000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 200000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 200);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 10);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 35);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 30);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 574, 50);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 20000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 1);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 1);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 1);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 1);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 1);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 1);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 1);
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, i11);
                                                InventoryServiceNew.gI().addItemBag(player, i12);
                                                InventoryServiceNew.gI().addItemBag(player, i13);
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 500000 && mocnap < 500000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 500000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 500);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 25);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 50);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 40);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 574, 150);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 50000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 3);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 3);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 3);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 3);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 3);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 3);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 3);
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 1200000 && mocnap < 1200000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 1200000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 1000);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 50);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 70);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 50);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 574, 200);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 100000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 5);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 5);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 5);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 5);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 5);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 5);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 5);
                                                ...
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 1200k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 2000000 && mocnap < 2000000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 2000000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 1500);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 80);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 100);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 80);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 2007, 250);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 150000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 7);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 7);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 7);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 7);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 7);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 7);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 7);
                                                Item i14 = ItemService.gI().createNewItem((short) 1681, 1);
                                                i14.itemOptions.add(new Item.ItemOption(50, 25));
                                                i14.itemOptions.add(new Item.ItemOption(77, 25));
                                                i14.itemOptions.add(new Item.ItemOption(103, 25));
                                                i14.itemOptions.add(new Item.ItemOption(14, 25));
                                                i14.itemOptions.add(new Item.ItemOption(5, 25));
                                                i14.itemOptions.add(new Item.ItemOption(30, 0));
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, i12);
                                                InventoryServiceNew.gI().addItemBag(player, i13);
                                                InventoryServiceNew.gI().addItemBag(player, i14);

                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 2000k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                            ...
                            switch (select) {
                                case 0:
                                    try {
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 2500000 && mocnap < 2500000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 2500000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 2000);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 100);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 250);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 200);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 2007, 300);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 200000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 10);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 10);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 10);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 10);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 10);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 10);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 10);
                                                Item i14 = ItemService.gI().createNewItem((short) 1543, 1);
                                                i14.itemOptions.add(new Item.ItemOption(50, 25));
                                                i14.itemOptions.add(new Item.ItemOption(77, 25));
                                                i14.itemOptions.add(new Item.ItemOption(103, 25));
                                                i14.itemOptions.add(new Item.ItemOption(14, 25));
                                                ...
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 2500k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                        ...
                        } else if (player.iDMark.getIndexMenu() == 124) {
                            switch (select) {
                                case 0:
                                    try {
                                        GirlkunResultSet checkmocnap = GirlkunDB.executeQuery(
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 3200000 && mocnap < 3200000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 3200000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 3000);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 120);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 300);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 350);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 2007, 350);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 300000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 15);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 15);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 15);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 15);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 15);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 15);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 15);
                                                Item i14 = ItemService.gI().createNewItem((short) 1578, 1);
                                                ...
                                                InventoryServiceNew.gI().sendItemBags(player);
                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 3200k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                        ...
                        } else if (player.iDMark.getIndexMenu() == 125) {
                            switch (select) {
                                case 0:
                                    try {
                                        GirlkunResultSet checkmocnap = GirlkunDB.executeQuery(
                                        ...
                                        if (checkmocnap.next()) {
                                            int mocnap = checkmocnap.getInt("mocnap");
                                            if (player.getSession().tongnap >= 4000000 && mocnap < 4000000) {
                                                GirlkunDB.executeUpdate(
                                                        "update account set mocnap = ? where id = ? and username = ?", 4000000, player.getSession().userId, player.getSession().uu);

                                                Item i = ItemService.gI().createNewItem((short) 457, 4000);//tv
                                                Item i2 = ItemService.gI().createNewItem((short) 674, 150);//dns
                                                Item i3 = ItemService.gI().createNewItem((short) 1395, 350);//xu vang
                                                Item i4 = ItemService.gI().createNewItem((short) 1861, 400);//tien
                                                Item i5 = ItemService.gI().createNewItem((short) 2007, 400);//may do boss
                                                Item i6 = ItemService.gI().createNewItem((short) 861, 350000);
                                                Item i7 = ItemService.gI().createNewItem((short) 14, 20);
                                                Item i8 = ItemService.gI().createNewItem((short) 15, 20);
                                                Item i9 = ItemService.gI().createNewItem((short) 16, 20);
                                                Item i10 = ItemService.gI().createNewItem((short) 17, 20);
                                                Item i11 = ItemService.gI().createNewItem((short) 18, 20);
                                                Item i12 = ItemService.gI().createNewItem((short) 19, 20);
                                                Item i13 = ItemService.gI().createNewItem((short) 20, 20);
                                                Item i14 = ItemService.gI().createNewItem((short) 1021, 1);
                                                Item i15 = ItemService.gI().createNewItem((short) 1896, 1);
                                                
                                                i14.itemOptions.add(new Item.ItemOption(50, 30));
                                                i14.itemOptions.add(new Item.ItemOption(77, 30));
                                                i14.itemOptions.add(new Item.ItemOption(103, 30));
                                                i14.itemOptions.add(new Item.ItemOption(14, 30));
                                                i14.itemOptions.add(new Item.ItemOption(5, 30));
                                                i14.itemOptions.add(new Item.ItemOption(30, 0));

                                                i15.itemOptions.add(new Item.ItemOption(50, 30));
                                                i15.itemOptions.add(new Item.ItemOption(77, 30));
                                                i15.itemOptions.add(new Item.ItemOption(103, 30));
                                                i15.itemOptions.add(new Item.ItemOption(14, 30));
                                                i15.itemOptions.add(new Item.ItemOption(5, 30));
                                                i15.itemOptions.add(new Item.ItemOption(30, 0));
                                                ...
                                                InventoryServiceNew.gI().addItemBag(player, i13);
                                                InventoryServiceNew.gI().addItemBag(player, i14);
                                                InventoryServiceNew.gI().addItemBag(player, i15);

                                                InventoryServiceNew.gI().sendItemBags(player);

                                                Service.gI().sendThongBao(player, "Tiến Hành Nhận Mốc Nạp 4000k");
                                                Thread.sleep(3000);
                                                //Service.gI().sendThongBao(player, "Bạn Đã Nhận Được " + cc.template.name);
                                            } else {
                                                this.npcChat(player, "Bạn đã nhận mốc nạp " + Util.format(mocnap) + "\nHãy Nạp Thêm Để Nhận Mốc Nạp");
                    ...
                    if (pl.iDMark.getIndexMenu() == 0) {
                        if (select == 0) {
                            createOtherMenu(pl, ConstNpc.IGNORE_MENU, "|5|Có 2 nhà cái Tài và Xĩu, bạn chỉ được chọn 1 nhà để tham gia"
                                    ...
                                    + "\n\n|7|Lưu ý: Nếu thắng, chiến binh sẽ nhận thêm được 80% số Hồng ngọc và Thỏi vàng đã đặt. Trong quá trình diễn ra khi đặt cược nếu thoát game trong lúc phát thưởng phần quà sẽ bị HỦY", "Ok");
                        } else if (select == 1) {
                            if (TaiXiu.gI().baotri == false) {
                                if (pl.goldTai == 0 && pl.goldXiu == 0 && pl.tvTai == 0 && pl.tvXiu == 0) {
                                    ...
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            ...
                                            + Util.format(TaiXiu.gI().tvXiu) + "Thỏi vàng"
                                            + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người"
                                            + "\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược TÀI : " + Util.format(pl.tvTai) + " Thỏi vàng", "Cập nhập", "Đóng");
                                } else if (pl.tvXiu > 0) {
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                                            + Util.format(TaiXiu.gI().tvTai) + "Thỏi vàng"
                                            ...
                                            + Util.format(TaiXiu.gI().tvXiu) + "Thỏi vàng"
                                            + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người"
                                            + "\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược XỈU : " + Util.format(pl.tvXiu) + " Thỏi vàng", "Cập nhập", "Đóng");
                                } else {
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                                            + Util.format(TaiXiu.gI().tvTai) + "Thỏi vàng"
                        ...
                        if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldTai == 0 && pl.goldXiu == 0 && pl.tvTai == 0 && pl.tvXiu == 0 && TaiXiu.gI().baotri == false) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                        ...
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.tvTai > 0 && TaiXiu.gI().baotri == false) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                        ...
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.tvXiu > 0 && TaiXiu.gI().baotri == false) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                        ...
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.tvTai > 0 && TaiXiu.gI().baotri == true) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                                            ...
                                            + Util.format(TaiXiu.gI().tvXiu) + "Thỏi vàng"
                                            + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người"
                                            + "\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược TÀI : " + Util.format(pl.tvTai) + " Thỏi vàng" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                    break;
                            }
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.tvXiu > 0 && TaiXiu.gI().baotri == true) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                                            ...
                                            + Util.format(TaiXiu.gI().tvXiu) + "Thỏi vàng"
                                            + "\n|1|Tổng người đặt XỈU: " + TaiXiu.gI().PlayersXiu.size() + " người"
                                            + "\n\n|5|Thời gian còn lại: " + time + "\n\n|7|Bạn đã cược TÀI : " + Util.format(pl.tvXiu) + " Thỏi vàng" + "\n\n|7|Hệ thống sắp bảo trì", "Cập nhập", "Đóng");
                                    break;
                            }
                        } else if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && pl.goldXiu == 0 && pl.goldTai == 0 && pl.tvTai == 0 && pl.tvXiu == 0 && TaiXiu.gI().baotri == true) {
                            switch (select) {
                                case 0:
                                    createOtherMenu(pl, 1, "\n|7|---CHAN ĐÊ ANH EM---\n\n|3|Kết quả kì trước:  " + TaiXiu.gI().x + " : " + TaiXiu.gI().y + " : " + TaiXiu.gI().z
                                            + "\n\n|6|Tổng nhà TÀI: " + Util.format(TaiXiu.gI().goldTai) + " Hồng ngọc, "
                            ...
                            switch (select) {
                                case 0:
                                    createOtherMenu(player, ConstNpc.BUY_DE_TU_VIP,
                                            ...
                                            //+ "\n|7|Đệ Super Bư: Hợp thể tăng 10% chỉ số"
                                            + "\n|7|Đệ Berus: 40k Vnđ, Hợp thể tăng 10% chỉ số"
                                            + "\n|7|Đệ Uub: 70k Vnđ, Hợp thể tăng 15% chỉ số"
                                            + "\n|7|Đệ Bư music: 120k Vnđ, Hợp thể tăng 20% chỉ số"
                                            + "\n|7|Đệ ngộ không: 300k Vnđ, Hợp thể tăng 25% chỉ số"
                                            //+ "\n|7|Đệ Pazuzz: 350k Vnđ, Hợp thể tăng 60% chỉ số"
                                            //+ "\n|7|Đệ Kaie: 500k Vnđ, Hợp thể tăng 70% chỉ số"
                                            + "\n|7| Lưu Ý Phải Có Đệ Thường",
                                            "Đệ Berus", "Đệ Uub", "Đệ\nBư music", "Đệ\nngộ không");
                                    break;
                                //case 1:
...
//                                        break;
                                    ...
                                    case 2:
                                        if (player.getSession().vnd < 120000) {
                                            ...
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 120k Vnđ");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                    ...
                                    case 3:
                                        if (player.getSession().vnd < 300000) {
                                            ...
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 300k Vnđ");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                    ...
                                    case 4: //pazuzu
                                        if (player.getSession().vnd < 350000) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 350k Vnđ");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
                                        ...
                                        player.getSession().vnd -= 350000;
                                        PetService.gI().createpazuzu(player, player.pet != null, player.pet.gender);
                                        break;
                                    case 5: //kaie
                                        if (player.getSession().vnd < 500000) {
                                            //                        if (player.pet.typePet == 5) {
                                            Service.gI().sendThongBao(player, "Bạn không có đủ 500k Vnđ");
                                            return;
                                        }
                                        if (player.pet == null) {
                                            Service.gI().sendThongBao(player, "Bạn cần phải có đệ tử thường trước");
    ...
    public static Npc baHatMit(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        // ----- Map 5: Thành phố chính -----
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Ngươi tìm ta có việc gì?",
                                "Ép sao\ntrang bị", // 0
                                "Pha lê\nhóa\ntrang bị", // 1
                                "Nâng Cấp\nSKH", // 2  ← gộp VIP + TL + Hủy Diệt
                                "Nâng cấp\nchân thiên tử", // 3  ← tách riêng
                                "Gia hạn\nvật phẩm", // 4
                                //                          "Khảm Đá",                   // ← comment, chưa dùng
                                "Ấn &\nTẩy Ấn\nKích Hoạt", // 5  ← gộp Ấn + Tẩy Ấn
                                "Pháp Sư\nTrang Bị", // 6
                                //                          "Luyện Hóa",                 // ← comment, chưa dùng
                                "Tinh luyện\nCải trang", // 7
                                //"Nâng cấp\ntrang bị", // 8
                                //                          "Thăng Cấp\nTrang Bị"        // ← comment, chưa dùng
                                "Phân Tách\nĐồ TL" // 9
                        );
...
//                          "Mở chỉ số\n Bí Tịch", "Đổi Sách\n Luyện\n Bí Tịch", "Luyện\n Bí Tịch");
                        ...
                        // ----- Map 42 / 43 / 44 và các map khác -----
                        this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                "Ngươi tìm ta có việc gì?",
                                //                          "Thưởng\nBùa 1h\ngẫu nhiên",  // ← comment từ code gốc
                                "Cửa hàng\nBùa", // 0
                                "Nâng cấp\nVật phẩm", // 1
                                "Nâng cấp\nBông tai\nPorata", // 2
                                //                          "Ép Chứng Nhận",              // ← comment từ code gốc
                                "Nhập\nNgọc Rồng", // 3
                                "Sách Tuyệt Kỹ" // 4
                        );
                    }
                    ...
                    if (this.mapId == 5) {
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
                                ...
                                case 1: // Pha lê hóa trang bị
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.PHA_LE_HOA_TRANG_BI);
                                    break;

                                case 2: // Nâng Cấp SKH → submenu gộp VIP + TL + Hủy Diệt
                                    createOtherMenu(player, ConstNpc.SKH,
                                            "Ngươi muốn nâng cấp SKH nào?\n",
                                            "Nâng SKH thường",//0
                                            "Nâng SKH\nVip", // 1
                                            "Nâng SKH\nTL", // 2
                                            "Nâng SKH\nHủy Diệt", // 3
...
//                  // === SUBMENU: KHẢM ĐÁ – comment, chưa dùng ===
//                  } else if (player.iDMark.getIndexMenu() == ConstNpc.KHAM_DA) {
//                      switch (select) {
//                          case 0: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.KHAM_DA_HP);   break;
//                          case 1: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.KHAM_DA_MP);   break;
//                          case 2: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.KHAM_DA_DAME); break;
//                      }
//                  // === SUBMENU: LUYỆN HÓA – comment, chưa dùng ===
//                  } else if (player.iDMark.getIndexMenu() == ConstNpc.LUYEN_HOA) {
//                      switch (select) {
//                          case 0: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_PET2); break;
//                          case 1: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_PK);   break;
//                      }
                            // === SUBMENU: PHÁP SƯ TRANG BỊ ===
...
//                                            break;
                            ...
                            // } else if (player.iDMark.getIndexMenu() == ConstNpc.TAY_SKH_TRANG_BI) {
                            //     if (select == 0) CombineServiceNew.gI().startCombine(player);
...
//                  // Submenu NANG_CAP_TRANG_BI – comment, chưa dùng
//                  } else if (player.iDMark.getIndexMenu() == ConstNpc.NANG_CAP_TRANG_BI) {
//                      switch (select) {
//                          case 0: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.DAP_SET_KICH_HOAT_HD); break;
//                          // case 0: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.kh_Hd);              break;
//                          // case 1: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.kh_T);               break;
//                          // case 2: CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.CHUYEN_HOA_DO_HUY_DIET); break;
//                          // case 3: NpcService.gI().createTutorial(player, this.avartar, ConstNpc.HUONGDANHIENTE); break;
//                      }
                        }
                            ...
                            switch (select) {
                                ...
                                case 1:
                                    if (player.diembitich >= 250) {
                                        ...
                                        Service.getInstance().sendMoney(player);
                                        Item SachBiTich = ItemService.gI().createNewItem((short) 1652, 1);
                        ...
                        if (player.iDMark.isBaseMenu()) {
                            switch (select) {
//                          case 0: // Thưởng Bùa 1h gẫu nhiên – comment từ code gốc
...
//                              break;
                                ...
                                case 1: // Nâng cấp Vật phẩm
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NANG_CAP_VAT_PHAM);
                                    break;
                                case 2: // Nâng cấp Bông tai Porata
                                    createOtherMenu(player, ConstNpc.MENU_NANG_BONGTAI,
                                            "Ngươi muốn nâng bông tai à",
                                            "Nâng Cấp\nBông Tai", "Mở Chỉ Số\nBông Tai", "Đóng"
                                    );
                                    break;
//                          case X: // Ép Chứng Nhận – comment từ code gốc
//                              CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.EP_CHUNG_NHAN_XUAT_SU);
//                              break;
                                case 3: // Nhập Ngọc Rồng
                                    CombineServiceNew.gI().openTabCombine(player, CombineServiceNew.NHAP_NGOC_RONG);
                                    break;
                                case 4: // Sách Tuyệt Kỹ
                ...
                if (canOpenNpc(player)) {
                    if (mapId == 0 || mapId == 182) {
                        ...
                        if (now > nguhs.TIME_OPEN_NHS && now < nguhs.TIME_CLOSE_NHS) {
                            this.createOtherMenu(player, 0, "Ngũ Hành Sơn x3 Tnsm\nHỗ trợ cho Ae trên 120 Tỷ SM?\nThời gian từ 15h - 23h, 5000 hồng ngọc 1 lần vào", "OK", "Đóng");
                        } else {
                            this.createOtherMenu(player, 0, "Ngũ Hành Sơn x3 Tnsm\nHỗ trợ cho Ae trên 120 Tỷ SM?\nThời gian từ 15h - 23h, 5000 hồng ngọc 1 lần vào", "OK");
                        }
                    }
                    if (mapId == 0) {
                        this.createOtherMenu(player, 0, "|7| Thí chủ muốn đến Ngũ Hành Sơn ...  ?\n"
                                + "|4|Ngũ Hành Sơn x3 TNSM \n"
                                + "|4|Thời gian từ 15h - 23h \n"
                                + "|4|Phí Vào : 5000 hồng ngọc \n"
                                + "|4|Sức Mạnh Yêu Cầu : 120 tỉ", "Vào Ngay", "Từ chối");
                    }
                    if (mapId == 122) {
                        ...
                        switch (select) {
                            case 0:
                                if (player.nPoint.power < 120000000000L) {
                                    ...
                                    Service.getInstance().sendThongBao(player, "Phí Vào Là 5000 hồng ngọc một lần\n bạn không đủ hồng ngọc để vào !");
                                    return;
                                } else {
...
//                                    InventoryServiceNew.gI().addItemBag(player, hopqua);
                                    ...
                                    if (randomItem == 0) {
                                        ...
                                        VatPham.itemOptions.add(new Item.ItemOption(50, Util.nextInt(10, 25)));
                                        VatPham.itemOptions.add(new Item.ItemOption(77, Util.nextInt(10, 25)));
                                        VatPham.itemOptions.add(new Item.ItemOption(103, Util.nextInt(10, 25)));
                                        VatPham.itemOptions.add(new Item.ItemOption(14, Util.nextInt(3, 8)));
                                        VatPham.itemOptions.add(new Item.ItemOption(101, Util.nextInt(15, 45)));
                                        VatPham.itemOptions.add(new Item.ItemOption(160, Util.nextInt(15, 30)));
                                        VatPham.itemOptions.add(new Item.ItemOption(95, Util.nextInt(10, 35)));
                                        VatPham.itemOptions.add(new Item.ItemOption(96, Util.nextInt(10, 35)));
                                        VatPham.itemOptions.add(new Item.ItemOption(93, Util.nextInt(10, 15)));
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (this.mapId == 50) {
                        ...
                        this.createOtherMenu(player, ConstNpc.BASE_MENU, "Chức năng đang được bảo trì",
                                "Đồng ý");
//                        try {
...
//                        }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    if (player.clan.doanhTrai_lastTimeOpen > 0
                            && System.currentTimeMillis() - player.clan.doanhTrai_lastTimeOpen > DoanhTrai.TIME_DOANH_TRAI) {
                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Ta đã thả ngọc rồng ở tất cả các map. Hẹn ngươi quay lại vào ngày mai", "OK");
                        return;
                    }
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    ...
                    // Nếu đang trong doanh trại và chưa rời
                    ...
                    if (player.clanMember.getNumDateFromJoinTimeToToday() < 1
                            || (player.clan.doanhTrai != null && player.clanMember.getNumDateFromJoinTimeToToday() < 1)) {
                    ...
                    // ✅ ĐÃ SỬA: Kiểm tra đúng theo ngày
                    long lastOpen = player.clan.doanhTrai_lastTimeOpen;
                    if (lastOpen > 0 && Util.isToday(lastOpen)) {
                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Bang hội của ngươi đã đi trại lúc "
                                + TimeUtil.formatTime(lastOpen, "HH:mm:ss") + " hôm nay. Người mở\n("
                                + player.clan.doanhTrai_playerOpen + "). Hẹn ngươi quay lại vào ngày mai",
                                "OK", "Hướng\ndẫn\nthêm");
                        return;
                    }

                    // ✅ Cho vào nếu chưa đi hôm nay
                    createOtherMenu(player, ConstNpc.MENU_JOIN_DOANH_TRAI,
    ...
    private static Npc popo(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                if (canOpenNpc(player)) {
                    if (player.clan != null && player.clanMember != null && player.clanMember.getNumDateFromJoinTimeToToday() < 2) {
                        createOtherMenu(player, ConstNpc.IGNORE_MENU,
                                "Map Khí Gas chỉ cho phép những người ở trong bang trên 2 ngày. Hẹn ngươi quay lại vào lúc khác",
                                "OK", "Hướng\ndẫn\nthêm");
                        return;
                    }
                    if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
...
//        case CombineServiceNew.DOI_DIEM:
                    ...
                    //           CombineServiceNew.gI().startCombine(player);
                    //      }
                    // reset để tránh lưu trạng thái khiến NPC tự động nâng khi mở lại
                    //      player.iDMark.setIndexMenu(-1);
                    //      player.combineNew.typeCombine = -1;
                    //      break;
                    // }
// Xử lý menu phân rã
//} else if (player.iDMark.getIndexMenu() == ConstNpc.MENU_PHAN_RA_DO_THAN_LINH) {
    ...
    public static Npc whis(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void confirmMenu(Player player, int select) {
                ...
                // Menu chính base menu ở map 154
                if (player.iDMark.isBaseMenu() && this.mapId == 154) {
                    switch (select) {
                        case 0:
                            // Mở menu chế tạo trang bị thiên sứ
                            this.createOtherMenu(player, 5,
                        ...
                        case 1:
                            ...
                            if (BiKiepTuyetKy != null) {
                                String info = "|7|Bí kiếp tuyệt kỹ: " + BiKiepTuyetKy.quantity + "/9999\n"
                                ...
                                if (player.gender == 0) {
                                    ...
                                    this.createOtherMenu(player, 6,
                                            "|1|Ta sẽ dạy ngươi tuyệt kỹ đíc chưởng liên hoàn\n" + info,
                                            "Đồng ý", "Từ chối");
                                }
                            } else {
                        ...
                        case 2:
                            // Thách đấu Whis
                            if (player.inventory.ruby < 500) {
                                this.npcChat(player, "Cần 500 hồng ngọc");
                                return;
                            }
                            if (player.nPoint.hpMax + player.nPoint.dame < 20000) {
                                this.npcChat(player, "Bạn còn quá yếu vui lòng quay lại sau");
                            ...
                            if (oldBossClone != null) {
                                ...
                                BossData bossDataClone = new BossData(
                                        ...
                                        new String[]{"|-2|Ta sẽ tiêu diệt ngươi"},
                                        new String[]{"|-1|Ta Sẽ đập nát đầu ngươi!"},
                                        new String[]{"|-1|Hẹn người lần sau"},
                                        1);
                                try {
                ...
                // Menu con "Chế tạo trang bị thiên sứ" (index menu = 5)
                ...
                // Menu "Nâng cấp" - người chơi vừa chọn nâng cấp trang bị thiên sứ (index menu = MENU_START_COMBINE)
                if (player.iDMark.getIndexMenu() == ConstNpc.MENU_START_COMBINE) {
                    if (select == 0) {
                        CombineServiceNew.gI().startCombine(player);
                    }
                    // Reset để tránh tự động nâng cấp khi mở lại menu
                    // player.iDMark.setIndexMenu(-1);
                    // player.combineNew.typeCombine = -1;
                    return;
                }

                // Menu học kỹ năng (index menu = 6)
                if (player.iDMark.getIndexMenu() == 6) {
                    if (select == 0) {
                        Item sach = InventoryServiceNew.gI().findItemBag(player, 1320);
                        if (sach != null && sach.quantity >= 9999 && player.inventory.gold >= 10_000_000 && player.inventory.gem > 99 && player.nPoint.power >= 1_000_000_000L) {
                            if (player.gender == 2) {
                                ...
                                case 0:
                                    if (player.playerTask.sideTask.template != null) {
                                        String npcSay = "Nhiệm vụ hiện tại: " + player.playerTask.sideTask.getName() + " ("
                                                ...
                                                + "\nHãy hoàn thành các nhiệm vụ để nhận lấy Vé NRO rồi hãy đổi chúng tại NPC Dende ở đảo kame nhé";
        ...
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            public void openBaseMenu(Player player) {
                ...
                if (canOpenNpc(player)) {
                    if (this.mapId == 5) {
                        createOtherMenu(player, ConstNpc.BASE_MENU,
                                "|2|Ta Vừa Chan Được Top Của Toàn Server\b|7|Mi Muống Xem Tóp Gì?",
    ...
    public static Npc createNPC(int mapId, int status, int cx, int cy, int tempId) {
        ...
        try {
            switch (tempId) {
                ...
                case ConstNpc.SHOP_DE_VIP://Dende Đảo kame
...
//                    return Vodai(mapId, status, cx, cy, tempId, avatar);
                ...
                case ConstNpc.CHOPPER:
                    return allsukien(mapId, status, cx, cy, tempId, avatar);
//                case ConstNpc.USHOP:
//                    return ushop(mapId, status, cx, cy, tempId, avatar);
                ...
                case ConstNpc.SSJ5:
                    return napvip(mapId, status, cx, cy, tempId, avatar);
                default:
                    return new Npc(mapId, status, cx, cy, tempId, avatar) {
                        @Override
                        public void openBaseMenu(Player player) {
...
//                        }
                    ...
                    case ConstNpc.PETSERVICE:
                        switch (select) {
                            case 0:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MUA_DE, 30274, "|7|Pet Service" + "\n" + "|1|" + "\n"
                    ...
                    case ConstNpc.MUA_DE:
                        switch (select) {
                            case 0:
                                this.createOtherMenu(player, ConstNpc.CONFIRM_MUA_DE_THIENTU, "Bạn có chắc muốn mua đệ Ngộ không không?", "Đồng ý", "Không");
                                break;
                            case 1:
                    ...
                    case ConstNpc.CONFIRM_MUA_DE_THIENTU:
                        switch (select) {
                            case 0:
                                ...
                                player.getSession().vnd -= 30000;
                                PetService.gI().createngokhong(player, true, player.pet.gender);
                                break;
                            case 1:
                    ...
                    case ConstNpc.CLCK:
                        switch (select) {
                            case 0:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.PETSERVICE, 30274, "|7|Pet Service" + "\n" + "|1|" + "\n"
                                        + "Chào bạn : " + player.name + " | ID: (" + player.id + ") | " + "Map : " + player.zone.map.mapName + "\n"
                                        + "Số Dư Khả Dụng : " + player.getSession().vnd + " VNĐ" + "\n"
                                        + "Chọn dịch vụ?" + "\n",
                                        "MUA\nĐỆ TỬ", "Đóng");
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_PLAYER, 30274,
                    ...
                    case ConstNpc.MENU_ADMIN:
                        switch (select) {
                            case 0:
                                this.createMenuConMeo(player, ConstNpc.ADMIN1, 30274, "|7| Ngọc Rồng As\b|2| ADMIN\b|4| Người Đang Chơi: " + Client.gI().getPlayers().size() + "\n" + "|8|Current thread: " + (Thread.activeCount() - ServerManager.gI().threadMap) + "\n",
                                        "Bảo Trì", "Tìm Kiếm\nPlayer", "Chat all");
                                break;
                            case 1:
                                this.createOtherMenu(player, ConstNpc.CALL_BOSS,
                                        "|2| PANNEL ADMIN - Ngọc Rồng As : CALL BOSS", "Cụm\nAndroid", "Goku\nBlack", "Broly", "Cụm\nCell",
                                        "Cụm\nDoanh trại", "Doraemon", "Fide", "Fide\nBlack", "Cụm\nGinyu", "Cụm\nNappa");
                                break;
                            case 2:
                                this.createOtherMenu(player, ConstNpc.BUFFITEM,
                                        "|2| PANNEL ADMIN : BUFF VẬT PHẨM - Ngọc Rồng As", "Buff\nItem", "Item\nOption", "Buff \nItem\nSKH");
                                break;
                            case 3:
                    ...
                    case ConstNpc.CONFIRM_ACTIVE:
                        switch (select) {
                            case 0:
                                ...
                                Service.gI().sendThongBao(player, "Bạn không có vàng\n Vui lòng vào trang chủ asnro.com để nạp thỏi vàng");
                                break;
                        }
                        break;
